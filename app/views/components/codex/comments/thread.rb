    ...
    class Thread < ApplicationComponent
      ...
      def view_template
        section(class: "space-y-3") do
          h3(class: "text-mini uppercase tracking-[0.4em] text-gaia-text-muted") { I18n.t("codex.comments.heading") }
          ...
          div(
            ...
            if @comments.empty?
              p(class: "text-tiny text-gaia-text-muted italic") { I18n.t("codex.comments.empty") }
            else

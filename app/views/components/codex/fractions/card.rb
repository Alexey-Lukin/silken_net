...
module Codex
  module Fractions
    class Card < ApplicationComponent
      ...
      def render_filled
        node = @fraction.node
        h3(class: "text-mini uppercase tracking-[0.3em] text-gaia-text-muted") { I18n.t("codex.fractions.my_heading") }
        ...
        div(class: "flex items-center gap-3 text-mini text-gaia-text-muted") do
          span { I18n.t("codex.fractions.since", date: @fraction.chosen_at.to_date.iso8601) }
          span { "·" }
          span { I18n.t("codex.fractions.updated", date: @fraction.last_changed_at.to_date.iso8601) }
        end
        a(
        ...
        ) { I18n.t("codex.fractions.change") }
      end

      def render_empty
        h3(class: "text-mini uppercase tracking-[0.3em] text-gaia-text-muted") { I18n.t("codex.fractions.my_heading") }
        p(class: "text-tiny text-gaia-text") { I18n.t("codex.fractions.empty") }
        a(
          href: api_v1_codex_fraction_picker_path,
          class: tokens(

    ...
    class Cooldown < ApplicationComponent
      ...
      def view_template
        ...
        span(
          ...
          title: I18n.t("codex.fractions.cooldown.title", timestamp: @fraction.cooldown_until.iso8601)
        ) do
          span { I18n.t("codex.fractions.cooldown.locked") }
          span { "·" }
      ...
      def render_open
        ...
        ) { I18n.t("codex.fractions.cooldown.open") }
      end

  ...
  class New < ApplicationComponent
    ...
    def header_section
      div(class: "text-center mb-10") do
        h2(class: "text-2xl font-extralight text-emerald-400 tracking-widest uppercase") { t("firmwares.new.title") }
        p(class: "text-tiny text-emerald-900 uppercase mt-2 tracking-[0.5em]") { t("firmwares.new.subtitle") }
      end
    end
  end
end

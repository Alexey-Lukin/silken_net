...
module TreeFamilies
  class Show < ApplicationComponent
    ...
    #
    # 🔴 Нуль на цих властивостях не нейтральний, і найгостріше це на
    # `fire_resistance_rating`: то ПОРІГ у °C, який `AlertDispatchService` звіряє з
    # температурою телеметрії, тож надрукований «0» — рівно те число, що робить
    # пожежну тривогу постійною; а сусідня форма дозволяє його ввести (валідація
    # нуль приймає). Тому підпис поруч мусить називати ту саму величину, що й число.

...
module BlockchainTransactions
  class Index < ApplicationComponent
    ...
    def token_type_styles(type)
      ...
      # ⚠️ Саме ЛЕГЕНДА цієї сторінки й зробила дефект видимим: вона друкує всі
      # три значення enum'а підряд, тоді як рядки таблиці показують лише ті, що
      # є в даних — тож на сторінках із carbon-фікстурою пара не існувала.

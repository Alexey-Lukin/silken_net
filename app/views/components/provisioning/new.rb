      ...
      div(class: "max-w-3xl mx-auto") do
        ...
        form_with(url: register_provisioning_index_path, scope: :provisioning, class: "space-y-8 p-10 border border-gaia-border bg-gaia-surface/80 backdrop-blur-md shadow-2xl") do |f|
          ...
          div(class: "pt-10 border-t border-gaia-border") do
            f.submit t(".submit"), class: "w-full py-4 bg-gaia-primary/10 border border-gaia-primary-strong text-gaia-primary-strong uppercase text-xs tracking-[0.3em] hover:bg-gaia-primary hover:text-gaia-primary-text transition-all cursor-pointer"
          end
        end
      end
    end

    ...
    def view_template
      div(class: "max-w-3xl mx-auto") do
        ...
        form_with(
          ...
          #
          # 🔴 Підказка називає ЦІНУ подання, і це несуче, а не ввічливість: цей запис
          # оголошує дерево мертвим (`EcosystemHealingWorker#declare_deceased!` → слешинг-
          # тракт) і виходить НЕЗВОРОТНОЮ заявкою в зовнішній реєстр. Людина, що
          # заповнює форму, — єдиний, хто ще може спинитись; після сабміту зупинки нема.

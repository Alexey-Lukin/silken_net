    ...
    module UI
      class EmptyState < ApplicationComponent
        ...
        def render_content
          ...
          # Декоративне в цьому дереві виключається ЯВНОЮ декларацією в реєстрі
          # `contrast_audit` (15 watermark'ів, `text-emerald-900/5` — свідомі
          # 1.09:1), ніколи автоматично за атрибутом.

...
module Views
  module Shared
    module UI
      # [SEC.25] Поверхня, якої в застосунку не було: `flash` ставився в 42 сайтах і
      # не читався НІДЕ — ані `DashboardLayout`, ані `AuthLayout` його не рендерили,
      ...
      class FlashMessages < ApplicationComponent
        # Дві категорії, бо рівно на дві діляться всі 42 сайти. Розширення
        # (`pending` · `security`) — окреме рішення з власним доказом, `00_07` SEC.25.
        KINDS = {
          "alert" => {
            role: "alert",
            live: "assertive",

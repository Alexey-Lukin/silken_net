...
class WalletPolicy < ApplicationPolicy
  ...
  # [UI.7] CSV-леджер — та сама грошова поверхня, що сторінка, лише в іншому
  # форматі; окреме правило було б другим означенням тенантності (прецедент
  # `transaction_status?` вище).
  def ledger?
    show?
  end

...
class AiInsight < ApplicationRecord
  ...
  # ⚠️ Живий споживач сьогодні ОДИН (`OracleVisionsController#index`); другий —
  # скоуп цитованої цілі — пішов зі зрізом шару Codex 2026-08-15. Форма лишається
  # модельною свідомо: вона про ЦІНУ помилки в цьому OR, а не про кількість читачів.

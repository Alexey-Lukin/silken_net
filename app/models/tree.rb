...
class Tree < ApplicationRecord
  ...
  # (нижче `VBAT_OK` BQ25570 закриває buck і знеструмлює MCU — низький запас у цій
  # архітектурі спостережуваний ЛИШЕ як тиша, ніколи як низьке число).
  # ⚠️ Поріг тут саме `VBAT_OK` (≈3.31 В, програмований), НЕ `VBAT_UV`: останній
  # внутрішній, 1.95 В, і є аварійним стопом кремнію, до якого шлях не доходить —
  # buck закривається на 1.4 В вище (`02_03 §4.В`, HW.7 2026-09-09).

...
class EwsAlert < ApplicationRecord
  ...
  enum :alert_type, {
    ...
    # [SLASH-1, 2026-09-04] Деградований uplink Королеви — вирізано з кошика
  ...
  # наперед: розкол `gateway_uplink_degraded` тихо звузив `Gateway#system_fault?`,
  ...
  GATEWAY_FAULT_TYPES = %i[system_fault gateway_uplink_degraded hardware_fault].freeze

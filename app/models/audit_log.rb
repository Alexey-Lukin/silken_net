...
class AuditLog < ApplicationRecord
  ...
  # розбіжність, і пін перестав би бути доказом. ⛔ Другий вільнотекстовий канал у тому
  # ж піні лежить ПОЗА цим переліком за побудовою — `telemetry_summary` (не `metadata`)
  # несе `AiInsight#summary` → `00_07` SEC.18.

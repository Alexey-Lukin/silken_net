...
class HardwareKey < ApplicationRecord
  ...
  # =========================================================================
  # Використовуємо non-deterministic шифрування (найвищий рівень безпеки).
  # Ключі дешифруються прозоро при зверненні.
  encrypts :aes_key_hex

  # --- НОРМАЛІЗАЦІЯ ---
  # Гарантуємо, що UID завжди в одному форматі для уникнення дублікатів
  ...
  # Синхронізовано з HardwareKeyService
  ...
  # [СИНХРОНІЗОВАНО]: Ротація ключа (OTA Key Update)

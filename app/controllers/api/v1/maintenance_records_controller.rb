...
module Api
  module V1
    class MaintenanceRecordsController < BaseController
      ...
      # --- ФІКСАЦІЯ ЗЦІЛЕННЯ ---
      # [`UI.18` HARD-gate] `Idempotency-Key` — передумова offline-черги польового
      # клієнта (реф перецілено з E.20 2026-08-24: черга потрібна лісникові Моделі A,
      # гільдія тут ні до чого):

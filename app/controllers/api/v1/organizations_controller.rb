...
module Api
  module V1
    class OrganizationsController < BaseController
      ...
      #
      # 🔴 І чого це НЕ робить: підписане ім'я стріму лишається дійсним назавжди
      # (детермінований HMAC без TTL, ActionCable підписку не ре-авторизує). Хто
      # зберіг токен, слухатиме стару організацію й після перемикання. Закриває це
      # лише org-epoch у самому імені — Ф3, `00_07` SEC.25.

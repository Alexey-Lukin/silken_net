...
module Dclimate
  ...
  class VerificationService
    ...
    # ПЕР-ПРОВАЙДЕРНІ. Чинну базу дає лише канал вендора (00_07 S3.2; клас — ARCH.118 §🗄️) — літерал
    ...
    def trigger_slashing
      ...
      # ⊕ `:draft` і `:fulfilled` сюди доходять, і незворотного вироку на них не буде:
      # ворота Кат-A судять лише ЧИННИЙ договір (`Slashing::CauseEvidence`), тож вони
      # йдуть у freeze. ⚠️ Попередня підстава — «no-op на нульовій базі» — була хибною:
      # база слешингу-за-провину кластерна, не договірна [SLASH-1, 2026-09-22].

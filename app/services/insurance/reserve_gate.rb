...
module Insurance
  ...
  # його ніколи не дебетує). Per-claim guard (`damage_ratio × insured_value`) капить одну
  # виплату, але АГРЕГАТНОГО cap немає — регіональна катастрофа мінтить пропорційно по всіх
  # кластерах без systemic stop-loss окрім `MAX_SUPPLY`.
  #
  ...
  # підхопить після відновлення. Дім політики — 07_01 §7; money-механіка — 04_02.
  # =========================================================================

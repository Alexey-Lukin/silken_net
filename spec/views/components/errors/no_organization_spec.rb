...
RSpec.describe Errors::NoOrganization do
  ...
  # сирою свідомо — `aria-hidden`-декорація. `text-gaia-primary` на CTA входить у відому
  # когорту «бренд-акцент ужито як текстовий токен» (`00_07` UI.3, 42 вузли) і лікується
  # ПАРНИМ токеном для всієї когорти, а не 43-м власним варіантом тут.

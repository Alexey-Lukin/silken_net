...
#   · 🔴 Паритет питає РІВНІСТЬ МНОЖИН, тож щойно `terraform/` оголосить ДРУГИЙ
#     мажор (репліка чи інстанс на іншій версії), гейт почервоніє — і це буде
#     чесний хіт, а не FP: «на якій версії CI судить код» стає неоднозначним
#     питанням, і відповідь мусить бути свідомою. Але повідомлення нижче радить
#     «вирівняти по продовому мажору» в однині — тоді читати його треба як
#     «обрати, ЯКИЙ із продових мажорів несе тестову правду», і записати вибір.

...
# ⛔ ЦЕЙ ФАЙЛ ВИКЛЮЧЕНО З `scripts/code_tracker_id_check.rb` ЗА ІМЕНЕМ — і саме тому
# напис стоїть ТУТ, а не лише там. Виняток названо пер-файлом (`EXEMPT` містить
# дослівний шлях), бо суцільний `spec/quality/` тихо вивів би з-під гейта всі інші
# quality-спеки. **Наслідок: перейменування або розділення цього файлу ламає виняток
# МОВЧКИ** — гейт почне червоніти на тест-даних нижче, а причина стоятиме в чужому
# скрипті. Перейменовуєш — правь `EXEMPT` тим самим комітом.
# ⊕ І самі дані нижче навмисні: «справжні на вигляд» ID (`DOC-T.5`, `UI.2-S`,
# `ARCH.35-Q2Q`) плюс фантоми (`DOC-T.999`) — вони є ПРЕДМЕТОМ піна, не недбалістю.

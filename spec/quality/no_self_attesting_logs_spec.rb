...
#      та сама хвороба на іншому носії (приклад класу, вже закритий — [`FW.63`]
#      до 2026-09-09 просував стан при ПОБУДОВІ відповіді, не при її отриманні).
#      Потребує власного детектора.

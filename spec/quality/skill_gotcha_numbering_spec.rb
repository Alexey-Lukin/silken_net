...
#   · 🔴 ВІДОМИЙ хибний позитив, якого сьогодні в дереві НЕМА (виміряно по всіх
#     скілах і промтах — нуль): рецепт, чий власний лік РОЗІРВАНО заголовком і
#     продовжено («4. 5.» під новим `##`), виглядає для гейта як відрізаний
#     хвіст. Дискримінатора між ним і справжнім дефектом не існує статично —
#     обидва є рядом, що не стартує з 1. Лік тоді НЕ послаблювати гейт, а
#     полагодити джерело: або злити рецепт під один заголовок, або почати
#     другу половину з 1. Якщо колись зʼявиться законний випадок, який так не
#     лагодиться, — це вже declaration-registry, а не ширший регекс.

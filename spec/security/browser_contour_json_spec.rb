...
#      червонило б чесний рефактор. ⚠️ Ціна цієї стелі виміряна на живому
#      прикладі — ключі, де сайти під одним записом мали різну природу. Живої
#      демонстрації в реєстрі зараз НЕМА: знайдеш новий багатосайтовий ключ із
#      різнорідними сайтами — впиши його сюди.

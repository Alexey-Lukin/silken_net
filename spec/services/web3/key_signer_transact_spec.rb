...
RSpec.describe Web3::KeySigner, "#transact" do
  ...
  describe "резерв газу (`assert_gas_reserve!`)" do
    ...
    # ⚠️ Три ЧИТАЧІ звірено ПОІМЕННО (мінт і Celo з [ARCH.62] ділять дім `Web3::NodeAnswer`,
    # але входи в нього різні): докстрінг, що НАЗИВАЄ споживачів, гниє тихіше за код,
    # тож звʼязок доводиться прогоном, а не абзацом.
    it "текст вироку читається як PRE-BROADCAST усіма ТРЬОМА читачами" do

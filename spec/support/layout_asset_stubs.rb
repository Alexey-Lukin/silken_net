...
#
# Тому глушимо ТІЛЬКИ реальну відсутність asset'а, а не виклик як такий:
# зібрані assets (`rails assets:precompile`, ~1 c) тепер доїжджають у браузер,
# а прогін без них поводиться рівно як раніше — жодна наявна спека не рухається.

...
#
# ⚠️ **«ОДИН дім» було завищенням, і adversarial-прохід 2026-08-19 довів це прогоном:**
...
#      ⚠️ **ПІДСТАВА під цим приписом була ХИБНА, і adversarial-прохід 2026-08-19
...
RSpec.describe "[UI.3] Колекційні сторінки: гігієна запитів", type: :request do
  ...
  # лишався невимірним (adversarial 2026-08-19 — зняття його не червонило).

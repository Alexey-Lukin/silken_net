...
SimpleCov.start "rails" do
  ...
  # `coverage.json`, тоді як усі пʼять гейтованих груп лишились байт-у-байт. Тобто сьогодні
  # гейт цілий рівно тому, що кожна гейтована група має файли. **Перейменувавши каталог або
  # звузивши `add_group`, спитай не «чи сюїта зелена», а «чи ця група ще має файли» —

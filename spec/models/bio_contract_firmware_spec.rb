  ...
  describe "validations" do
    ...
    describe "bytecode_payload format" do
      it "accepts valid even-length HEX payload" do
        firmware = described_class.new(version: "1.0.0", bytecode_payload: "AABBCC")
        firmware.valid?
      ...
      it "rejects odd-length HEX payload" do
        firmware = described_class.new(version: "1.0.1", bytecode_payload: "ABC")
        firmware.valid?
      ...
      it "rejects single character HEX payload" do
        firmware = described_class.new(version: "1.0.2", bytecode_payload: "A")
        firmware.valid?
      ...
      it "accepts two-character HEX payload (one byte)" do
        firmware = described_class.new(version: "1.0.3", bytecode_payload: "FF")
        firmware.valid?

...
Source-tree integrity (signed commits / tags) is **in force**: `required_signatures` is
enabled on `main` since 2026-09-02. Mechanism and provenance live in
`docs/06_07_CICD_and_Runbook_Index.md` §2; the tracker item that carried it (`OPS.10`) was
closed 2026-09-05 and is a §🗄️ archive row — cite it as provenance, not as open work.

...
100.times do |i|
  ...
  # дає ρ(temp) + (max − BASE_RHO), тож при аномальних 41 °C це 36.2 + 17 = **53.2**, а
  # не 45. Тут стоїть 55.0 — саме щоб пара (`z_value`, `bio_status`) сходилась із тим, що
  # порахувало б відвантажене ядро; 48.5 при 41 °C ядро класифікує як ГОМЕОСТАЗ.
  ...
  # ~38 % cold-start зерен перетинають 53.2 (2 000 прогонів `calculate_z_from_state`).
  #

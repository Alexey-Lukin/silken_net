...
def main() -> int:
    ...
    print("     sway spectrum is bench/field (08_02). Comparative supported-vs-unsupported is robust.")
    ...
    out = {
        ...
        "caveats": "cyclic-load amplitude (pogo friction + PEEK flex) is an estimate; real sway spectrum "
                   "is bench/field (08_02). Comparative supported-vs-unsupported + per-alloy ranking robust.",
    }

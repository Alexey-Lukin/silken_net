...
(Гончаров, 08_02 — currently unresponsive, so the geometry is self-owned, not blocked on him).
...
def main() -> int:
    ...
    out = {
        ...
        "rf_constraint": {"antenna_ti_clearance_min_mm": RF_ANT_TI_CLEARANCE_MIN,
                          "note": "geometric (self-owned); VNA/HFSS lab-side Гончаров 08_02, unresponsive"},

...
-----------------------------------
  j_max = lib.constants J_MAX_25C — the MM asymptote of dgrGcGDH derived from Zafar 2012 Table 1
          (881 µA/cm², a pH-7.4 graphite ceiling; the number lives THERE, this line must not restate it)

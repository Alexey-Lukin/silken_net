...
⚠️ A profile is not a medium anyone can prepare. Several list calcium and oxalic acid together at millimolar
levels — the pair script 67 finds supersaturated to calcium oxalate at every corner of the `01_02 §2.1` recipe
(00_07 HW.3). The MD results are untouched for a plainer reason than it may look: script 14 builds its box from a
profile's `ph` and `ionic_strength_M` alone, filling it with Na+/Cl-, so the pair never entered a simulation. Do not

...
# Канон (02_05 §4/§Зимовий · 07_01 §14/§4а) ПОСИЛАЄТЬСЯ сюди, не restate'ить:
...
PARAMS = {
  ...
  # ── генерація ─────────────────────────────────────────────────────────────
  panel_w: 50.0,           # ⚖️ panel-decision Phase 1/2.5: 10 vs 50 (07_01 §14 ↔ 02_05)
  ...
  # ── батарея / гейт ────────────────────────────────────────────────────────
  battery_ah: 20.0,        # LiFePO4 12V (02_05 §7 поз.7; 07_01 §14 брав 6 Ah)
  battery_v: 12.0,

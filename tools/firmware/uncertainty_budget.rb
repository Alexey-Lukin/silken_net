...
PARAMS = {
  # ── робоча точка (02_03 §9.6 Variant C — беззапасна точка) ───────────────────
  delta_t_s: 7027.0,      # 1.95 год — ⚖️ 2026-09-26: = енергомодель tx_cadence_budget.rb (ECB, 16 Б); CCM 30 Б → ≈ 2.22 год, m = 0

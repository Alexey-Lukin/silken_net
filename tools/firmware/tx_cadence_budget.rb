...
#     Отже за цими членами H нижче — НИЖНЯ межа; але тривалості TinyML/Lorenz (`tinyml_mj`,
#     `lorenz_mj`) — стелі й тягнуть навпаки, тож знак сумарної похибки не визначено, і H —
#     сценарна точка (`02_03 §9.4`). η_buck 0.88 при ~24 мА стоїть на краю діапазону, для
#     якого канон її тримає.

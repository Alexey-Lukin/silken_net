...
public class TopologyCrossChecksTests
{
    ...
    // the same six read about a percent (01_02 §6); `stepped` alone is still on the sheet formulation
    // and carries most of its lattice metal below the floor — the ground of the ratified verdict that
    // it is µ-LPBF only (01_01 §5.5).

...
- **ML-партнера НЕМА.** Нас ніщо не обмежує — ця модель **наша end-to-end**, не викидний
  stub «до Бушина». Якщо партнерство не матеріалізується, baseline можна доростити до
  продакшну. Аспіраційний ростер (Бушин — CNN-архітектура; Любченко — NSGA-II
  ...
  toolchain. Це узгоджено з [`08_01` Стаття 24a](../../../docs/08_01_Joint_Publications_and_IP_Strategy.md):
  *Архітектор володіє DSP+firmware; партнер (за наявності) тренує/оптимізує 5-class CNN.*
...
- **Ripple** — 02_01 latency, 08_01 Стаття 24a footprint, 03_01 vendor-table (current vs

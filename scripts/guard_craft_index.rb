...
#
# ЧОМУ. `ssot-maintenance/SKILL.md` авто-інвокується майже щосесії, і 81 kB із
# нього — 42 пункти «як гейт не бачить власної поверхні». Вони потрібні при
...
# 42 правил, тобто 51-й дзеркальний шар у корпусі, який уже виміряв, чим це
...
# `Reflex:`-клауз мають 26 із 42 (16 без). ⚠️ Перша редакція цієї шапки писала
# «31 із 42», і хиба була в НЕОГОЛОШЕНІЙ ОДИНИЦІ: `grep -c` рахував жирні
# СПАНИ, а число доповідалось як ПУНКТИ — а пункти з кількома рефлексами (#28
# має шість) роздувають лічильник. Хибне число стояло в тулі, збудованому
# лікувати рівно цей клас. Решта мусять мати лід, що стріляє сам —

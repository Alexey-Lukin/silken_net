...
#
# Mutation-verified ×3, кожен клас в ізоляції з відкотом між: роль без рядка в
# реєстрі · рядок із порожнім вироком · нова роль, оголошена в контракті. Спеки в
# цього скрипта немає, тож ця шапка — єдиний запис, що доказ був зроблений.
# ⚠️ Перша спроба ДРУГОЇ мутації була NO-OP: вона влучила в рядок СУСІДНЬОЇ таблиці
# ролей SCC, тобто поза судимою множиною, і «зелено» читалось як доказ. Форма
# небезпечна саме в реєстрах: сусідня таблиця тих самих сутностей виглядає як
# ціль (§Guard-craft #65 — перш ніж читати зелену мутацію як «пін слабкий»,
# перевір, чи мутоване взагалі належить до множини, яку пін судить).
#

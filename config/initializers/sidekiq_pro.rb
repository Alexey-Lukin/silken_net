...
#
# 🔴 «Делегують без обмежень, вимкнено лише enforcement» — правда РІВНО для
# `Limiter` (rate-limit і Є enforcement). Для `Batch` — НІ: колбек не enforcement,
# а ГІЛКА ТРАКТУ, тож без гема вона не виконується взагалі, і споживач, чий
# єдиний пускач жив у колбеку, стоїть мертвим [ARCH.59]. Поіменний периметр,
# присуди та порядок активації — `04_02 §11` DOC-R.10.
#

 ...
 * власна вільна сторінка 125 (карта Королеви — 03_01 §7 + main.c коментар
 * біля queen_kv: 122-123 Helium-KV [ARCH34_HELIUM_ENABLED, gated] · 124
 * ключі KEYB/KEYC/EDSK · 127 UID; 125-126 нічим не заявлені). Мерджити

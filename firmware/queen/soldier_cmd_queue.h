...
/* Бюджет пострілів на кадр: повний CIFO ≈ кластер із 50 Солдатів, і кожен
 * постріл летить услід за чиїмось uplink'ом ⇒ 64 постріли покривають понад
 * один повний оберт кластера — вікно цільового Солдата влучене щонайменше
 * раз. Кожен постріл ≈ 165 мс ефіру (16 Б @ SF9 — `Lora_Phy_Time_On_Air_Ms`),
 * тож 64 постріли ≈ 10.6 с ефіру на кадр; годинної стелі робочого циклу TX
 * Королеви ця константа не тримає — то робота лімітера (00_07 FW.61). */

...
/*
 * [ARCH.34 owned] se-identity Королеви — заповнений ST-шаблон
 * (Conf/se-identity_template.h; макро-контракт soft-se лишено недоторканим).
 * ⚠️ УСІ значення нижче — НУЛІ-плейсхолдери, НЕ ключі: бойові
 * DevEUI/JoinEUI/AppKey приходять bench-провіженінгом (03_06; Helium
 * Console реєструє ту саму трійку — 00_07 ARCH.34 👤). DevEUI=00…00 →
 * деривація з GetUniqueId (STM32 HW UID) — per-Queen без прошивки в код.
 */

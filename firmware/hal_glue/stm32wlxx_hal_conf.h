/*
 * stm32wlxx_hal_conf.h — [FW.46] SilkenNet HAL-конфіг (CubeMX-замінник, owned).
 *
 * Походження: stm32wlxx_hal_conf_template.h з vendored stm32wlxx-hal-driver
 * (pinned v1.6.0, firmware/extern/) — увімкнено РІВНО периферійний набір
 * soldier/main.c + queen/main.c (ADC/CRYP/DMA/FLASH/GPIO/IWDG/RNG/RTC/
 * SUBGHZ/TIM/UART + базові CORTEX/PWR/RCC/EXTI). Вимкнені модулі позначені
 * «не використовується» — вмикати разом із новою периферією в main.c.
...
/* #define HAL_COMP_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_CRC_MODULE_ENABLED */ /* SilkenNet: не використовується */
#define HAL_CRYP_MODULE_ENABLED
/* #define HAL_DAC_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_GTZC_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_HSEM_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_I2C_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_I2S_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_IPCC_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_IRDA_MODULE_ENABLED */ /* SilkenNet: не використовується */
#define HAL_IWDG_MODULE_ENABLED
/* #define HAL_LPTIM_MODULE_ENABLED */ /* SilkenNet: не використовується */
/* #define HAL_PKA_MODULE_ENABLED */ /* SilkenNet: не використовується */
...
/* #define HAL_WWDG_MODULE_ENABLED */ /* SilkenNet: не використовується */

...
| 5.2 Живі транскрипти | minicom-лог: ATE0/AT/CNMP/**CGDCONT**/CPSMS/CEDRXS/**CNACT** + CDNSGIP + CCOAPNEW/SEND/DEL (порядок з `03_02 §4`; CGDCONT/CNACT — HW.41) | лог ≡ скриптовані транскрипти `test_at_engine.c` (URC-порядки, таймінги) |

...
| 2.5 FW.23 OTA dual-gate e2e | K_ota вже у транскрипті factory (Гілка A KOTA-блок `0x0803E800`; крок 1.3 пише його разом з KEYL/LSED) → OTA-day: валідний bytecode → APPLY; підмінений байт тіла (валідний CRC32) → REJECT + magic-wipe | обидва вердикти на платі ≡ host-тестам | FW.23 остаточно |

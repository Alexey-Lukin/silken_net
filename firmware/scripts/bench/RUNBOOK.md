...
| Крок | Як | Очікуване |
|---|---|---|
| 5.1 **Verbatim-звірка ноти** | роздобути SIM7070_…_CoAP(S)_Application Note **V1.03** (Techship/SIMCom; публічні дзеркала 403) і звірити проти `03_02 §4`. AT Manual V1.03 + TCPUDP-нота V1.02 звірені посторінково лише на до-HW.41 команди (FW.60-розвідка 2026-07-12, `03_02 §4`) — ⚠️ **`AT+CGDCONT`/`AT+CNACT` (HW.41, 2026-09-09) верифікації ЩЕ НЕ пройшли**: граматика зі стандарту (3GPP TS 27.007 §10.1.1) і з загального SIMCom TCP/IP набору відповідно, не з цієї ноти — той самий клас ризику, що FW.56 колись мав. Residual = CoAP(S)-нота + обидві нові команди | граматика збігається АБО оновити `at_engine`-транскрипти |

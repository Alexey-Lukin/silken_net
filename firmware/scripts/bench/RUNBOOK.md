...
- **П'єзо interrupt-storm поріг** (`03_03 §1.2`, HW.30 cb-4/5) — ✅ архітектуру ратифіковано 2026-09-10 (HW.30): hardware R-дільник + RC-поріг перед EXTI (DNP-контур, `02_01 §3` поз. 6) — перша лінія, SW rate-limiter — друга. На bench лишаються **номінали** дільника/RC і поріг SW-лінії, обидва калібруються на [bench:acoustic]-ризі (cb-5, post-coupling).

...
//
// DID == 0 зарезервовано: бекенд відкидає нульовий DID в обох ерах (ARCH.54,
// 03_02 §7), тож нуль детерміновано відображається у "SNET"-константу. Колізії 32-біт ловить

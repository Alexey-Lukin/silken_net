...
38. Єдиний живий доказ Кат-A гасить ПОБІЧНИЙ ефект чужого запису: привʼязка `MaintenanceRecord` до тривоги закриває її будь-якого типу, а `positive_a?` бачить `vandalism_breach` лише незакритим

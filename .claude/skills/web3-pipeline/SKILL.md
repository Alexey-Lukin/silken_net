...
20. A money row carries TWO units in adjacent columns, and the model has no explicit DIRECTION — both gaps are load-bearing — **Reflex when you touch any money row: name the UNIT of every scalar you pass, and ask what marks its DIRECTION — neither is visible in the column name**

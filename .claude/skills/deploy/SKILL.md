...
- 🔴 **Що метрика ОЗНАЧАЄ, вирішує її СПОЖИВАЧ, а не докстрінг** (INF.26, 2026-08-13).
  ...
  **Рефлекс: перш ніж судити метрику, знайди її `expr` у `deploy/grafana/` і прочитай ЗАГОЛОВОК
  панелі — саме він каже, що з нею роблять.** ⊕ Дзеркало: **24 метрики споживача не мають
  ЗОВСІМ**, і для них «полагодити» — ратчет, а не ремонт; ціна інша, питання теж (`00_07` INF.26).

...
80. Реєстр, що класифікує КОЛОНКИ, до ВМІСТУ JSONB сліпий за побудовою — і ціну задає не колонка, а КАНАЛ, у який той вміст їде — **побачив JSONB/text-колонку — спитай не «чи вона в реєстрі», а «хто читає її ВМІСТ і куди той вміст їде»; якщо канал незворотний, стеля мусить бути ДЕКЛАРАЦІЄЮ (оголошений перелік ключів + відмова на межі), бо форма ключа не каже, чи значення персональне — це рішення людини, і гейт має судити його НАЯВНІСТЬ, як робить сусідній PII-реєстр**

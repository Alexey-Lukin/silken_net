...
- **Мінтинг guard-clauses:** `verified_by_iotex? && oracle_status_fulfilled? && hadron_kyc_status == "approved"`; `WEB3_STRICT_MODE=true` (prod) → стаби-raises → `05_02` / `web3-pipeline`.

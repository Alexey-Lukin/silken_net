...
This project is indexed by GitNexus as **silken_net** (11013 symbols, 19791 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
**Поточний TRL**: firmware TRL 6, backend TRL 8, hardware TRL 4-5.
...
This project is indexed by GitNexus as **silken_net** (8093 symbols, 15590 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/silken_net/process/{processName}` — trace the full execution flow step by step

...
gem "rails-i18n"
# [OPS.22 · CVE-2026-80212/80213] Default-гем `resolv` Ruby 4.0.6 = 0.7.0 — у вразливому
# діапазоні 0.4.0–0.7.1 (ruby-lang 2026-08-27: DoS памʼяті + обхід SSRF-фільтра); лік — гем
# 0.7.2. Шляхи в нас: `ssrf_filter` (транзитив `css_parser`) кличе `Resolv.getaddresses`,
# `httpx` кодує/декодує DNS-повідомлення. ⛔ Default-геми сліпі для ОБОХ advisory-каналів,
# тож повторного алерту не буде; знімати разом із бампом Ruby до 4.0.7 (везе resolv 0.7.2).
gem "resolv", "~> 0.7.2"

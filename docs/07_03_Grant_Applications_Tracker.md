...
| **Demo** (Lorenz-математика документована; рендер-візуалізації нема) | 🔴 Потрібно | 03_04 (проза/формули) |
...
> **Ключовий інсайт:** Наявність **технічної документації та мануалу з монтажу** переводить проєкт із категорії «гола ідея» в категорію «документований, buildable-дизайн». Це критично для оцінки фондами (Gitcoin/Giveth) та кліматичними організаціями.
...
> **Стратегічний рівень:** Web3-екосистемні гранти (секції 1-6) покривають технічну інфраструктуру. Horizon Europe та Ethereum Foundation гранти легітимізують проєкт для інституційних інвесторів та ESG-регуляторів ЄС.

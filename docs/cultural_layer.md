...
#### Мельниченко В. — Краєзнавство → історичний контекст Master Nodes

- **Звання:** проф. ЧДТУ (краєзнавство); Засл. працівник культури; очільник Черкаського осередку Спілки краєзнавців. Не митець — краєзнавець; тут, бо його предмет той самий культурний шар карток Master Nodes.
- **"Код":** історико-культурна топографія Черкащини — Холодний Яр, скіфські городища.
- **Резонанс:** історичний контекст для карток Legacy Master Nodes — у парі з візуальним словником Гуменюка (↑). ⛔ Висоти Queen-шлюзів за «історичними оглядовими точками» не обирати: висоту судить link budget ([`02_01 §5`](02_01_Hardware_Architecture_and_BOM)), не історія місця.

# 09_04: ЧДТУ — Академічне Партнерство з Data Science та Прикладної Статистики
...
**Рекомендована стратегія:** 2-3 публікації на рік, починаючи з Q2 та зростаючи до Q1.

| Рік | Стаття | Журнал (target) | Задачі |
|-----|--------|-----------------|--------|
| 2026 | Time Series Decomposition of Bio-Telemetry from IoT Forest Monitoring | Sensors (Q1, MDPI) | #1, #2, #6 |
| 2026 | Utility Functions for Autonomous Decision-Making in Energy-Constrained IoT | Expert Systems with Applications (Q1) | #27, #29, #30 |
| 2027 | Anomaly Detection in Large-Scale Forest Telemetry Streams | IEEE IoT Journal (Q1) | #22, #24, #25, #26 |
| 2027 | Lyapunov Exponents and Recurrence Analysis of Lorenz-Based Tree Health Index | Chaos, Solitons & Fractals (Q1) | #7, #8, #9 |

**IP стратегія:** Спільне авторство (ЧДТУ + Silken Net). Open-source код. Дані деанонімізуються. Детальна стратегія — [`08_03_Joint_Publications_and_IP_Strategy`](08_03_Joint_Publications_and_IP_Strategy).
...
ЛАНЦЮГ 1: Lorenz Pipeline
  ...
  │ • Float32 vs Float64    │───────────────>│ • Ляпуновські показники │

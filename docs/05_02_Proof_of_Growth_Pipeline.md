...
> **Крипта доповнює, не замінює:** L0–L2 доводять, що голос **дерева** і **цілий**; але **ЗВТ-метрологія** (STK.5) доводить, що голос **точний** (legal/CBAM carbon), а **operator-bond + slashing** (BIZ.13) робить брехню **дорогою**. Трійця (origin + accuracy + skin-in-game) = довірений RWA. Жоден рунг ladder не знімає потреби у ЗВТ та економічному шарі.

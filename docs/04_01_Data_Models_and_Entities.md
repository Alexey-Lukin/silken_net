...
ДЕКЛАРАЦІЄЮ людини, не виводом регексу. ⚠️ **Судяться КЛЮЧІ, ніколи ЗНАЧЕННЯ:** `error`
несе текст чужого RPC/винятку, тож він лишається каналом, і його звуження — окреме питання
([`00_07`](00_07_Action_Plan_Tracker) SEC.18). ⛔ Периметр вужчий за таблицю: `Auditable`

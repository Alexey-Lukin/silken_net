...
>
> ⊕ **Друга, НЕЗАЛЕЖНА підстава того самого присуду — крос-модульний прохід** [ARCH.59, 2026-08-21]. `Mrv::LineageReportService` гілки «джерельні рядки застаріли» не має ВЗАГАЛІ: при рядковому видаленні листя він видав би зовнішньому аудиторові `unprovable_regrouped` («дерево змінило кластер») — тобто чужий діагноз на нашу власну ретеншн-дію. А пін архівного батча їде чергою `low`(9/9 strict), тож семиденний DELETE встигав би випередити його, і `archiveRoot`, уже записаний on-chain, лишався б без відновлюваного офчейн-свідка. ⊕ **Чесний негатив, вартий рядка:** грошей це не чіпало — сума мінту рахується в ingest-час, а lineage-перерахунки на шляху dispatch явно fail-open.

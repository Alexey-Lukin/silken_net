...
- [ ] 👤 **Build orientation specification** (`01_02` §1.6): BD ∥ довгій осі анкера (вертикальний друк, кінчик донизу), кут до build plate 0° ± 5°, externally only support
...
- [ ] 👤 Stacking: 3-анкерна тестова конфігурація на одному дереві з PEEK-ізоляцією (Деталь 2)

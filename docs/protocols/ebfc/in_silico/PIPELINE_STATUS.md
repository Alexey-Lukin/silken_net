...
| 55 | `bus_mechanical` | **HW.34** bus rod на канон-роді **Ø1.0**: buckling SF 10× (pogo) — non-issue; sway-fatigue SF 4.2–11.7× WITH liner (= insulation + support). 🔴 Unsupported — **нескінченного ресурсу не має ЖОДЕН** із шести (SF 0.71–1.94): Ta 0.71 і CP-Ti 0.98 = прогнозована відмова, решта marginal. Отже бічна опора — вимога, не пом'якшення для м'яких сплавів (вхід у ⚖️ lining, `00_07` HW.34) | `mechanical/bus_mechanical.json` |

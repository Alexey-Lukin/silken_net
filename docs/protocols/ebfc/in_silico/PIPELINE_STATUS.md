...
| 55 | `bus_mechanical` | **HW.34** bus rod на канон-роді **Ø1.0**, ДВІ гілки фабрикації (`printed` superseded ⊥ `welded` SHIPPED, ⚖️ 2026-09-10): buckling SF 10× (pogo) — non-issue; sway-fatigue WITH liner — нескінченний ресурс для КОЖНОГО сплаву в обох (SF 4.2–11.7× / 8.5–23.3×). 🔴 Unsupported вирок задає ФАБРИКАЦІЯ: друкований — **не має ЖОДЕН** із шести (SF 0.71–1.94, Ta 0.71 і CP-Ti 0.98 = прогнозована відмова); зварений — відмов **немає жодної**, але нескінченний ресурс мають **4 з 6** (SF 1.41–3.89), Ta 1.41 і CP-Ti 1.96 нижче межі. Отже звар опору звузив, а не скасував (вхід у ⚖️ lining, `00_07` HW.34). ⛔ Шва модель не має — подвоєння про ДРІТ, не про ЗʼЄДНАННЯ | `mechanical/bus_mechanical.json` |

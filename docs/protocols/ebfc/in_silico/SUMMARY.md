...
|---|---|---|---|---|
| **23 mm** (CEM-derived, shipped) | 41.3 % | 43.2 MPa | **0.556** | **DOES NOT CLEAR**, −0.056 |
...
|---|---|---|---|---|
| 0.40 | 5 / 6 | **1.96** | 0.626 | does not clear |
| 0.45 (model) | 6 / 6 | 2.21 | 0.556 | does not clear |
| 0.50 | 6 / 6 | 2.45 | **0.501** | does not clear |

🔴 **«All six clear SF 2» FLIPS inside the band; «our as-printed marker covers the seam» does NOT — it fails at both ends.** The second half is the one worth reading twice: the marker was already known not to clear at the model's midpoint (−0.056), and the sweep shows the friendliest end of the whole band still leaves it short by **0.001**. So the seam conclusion is robust to this coefficient and the fatigue conclusion is not — the opposite of what a reader would guess from which of the two sounded shakier. ⛔ The seam column is priced at §5's OWN corner (worst swept µ × span optimism) and pinned to equal its headline at the model's ratio, because the same quantity at a different corner is the substitution this file keeps catching elsewhere. ⛔ Which end to stand on is a ⚖️ (`00_07` HW.34) — the block measures, it does not choose, and the band ends are the constant's own comment, not a measurement of our alloys.

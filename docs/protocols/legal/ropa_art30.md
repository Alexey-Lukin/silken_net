...
| Усі §2.x — DSAR self-serve tooling | ✅ **відвантажено** (експорт Art.15/20 + erasure Art.17 зі step-up, ⚖️ 2026-08-21) — рядок оновлено 08-23, доти ще й адресував заархівований `ARCH.57`; у `SEC.18` лишається ФОРМА стирання там, де запис незнищенний (аудит-ланцюг ⊥ оригінали фото) |

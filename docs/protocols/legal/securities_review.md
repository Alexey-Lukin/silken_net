...
| F14 | **RWA-токенізація UA-лісу:** `hadron_asset_id` = «ID лісової ділянки як RWA в Polygon Hadron» (ERC-3643 KYC-шар) | [`00_04 §5`](../../00_04_Nature_as_a_Service_Contracts.md); `Polygon::HadronComplianceService#register_asset!` (пише `naas_contracts.hadron_asset_id`) | Блок 2 (лісове право) |

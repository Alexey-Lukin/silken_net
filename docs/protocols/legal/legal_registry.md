...
| [`tax_posture_ua.md`](tax_posture_ua.md) | Податкова постава UA: SCC-дохід, ПДВ на carbon-послугу, фіат-операційка, питання до економістів | [`05_03`](../../05_03_Tokenomics_SCC_and_SFC.md) (on-chain dynamic-tax ≠ фіскальний) · [`02_06 §7`](../../07_01_Nature_as_a_Service_Contracts.md) | **UNI.14** (Ус/Гедз) |

...
5. **B2C track (`07_01 §1.2`)** прямо описує individuals, що хочуть **"монетизувати"** свій ліс: SCC + мікро-USDC-нагороди (0.01-0.1 USDC/LoRa-пакет) + Celo ReFi (5 cUSD/добу) — DePIN-style "заробіток за участь" fact-pattern (та сама категорія, що привертала SEC-увагу до Helium-подібних мереж).

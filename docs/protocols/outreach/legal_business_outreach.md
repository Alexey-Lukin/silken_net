...
2. **[`00_07`-прямий]** UNI.14 = **юр-хаб**: один воркшоп Аблязова фанається в BIZ.20-carve-out · BIZ.2 · BIZ.15 · UNI.16 · STK.3 · **BIZ.17** (юр-review CDA/NDA-каркаса — він же розблоковує лаб-доступ UNI.2) · **UNI.20** (IP-пункт у ЧНУ-MoU) · **BIZ.22** транзитивно через UNI.16. ⛔ **Перелік не скорочувати:** доти тут стояли перші пʼять, а рядок «Воркшоп Аблязова» в `00_07 ⛓️` — дім цього набору — прямо каже, що занижений перелік означає пакети, лишені вдома.

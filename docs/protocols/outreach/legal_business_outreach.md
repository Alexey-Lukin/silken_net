...
| `legal/spdx_rollout_plan.md` | ⚖️ founder САМ → 🤖 виконання | ✅ scope-присуд ухвалено 2026-07-26 (усі три «так»: `config/` · `terraform`+`subgraph` · `spec/`) — лишається 🤖 скрипт + прогін | SPDX-теговане дерево (свідомо DEFERRED, Phase 7) | ліцензійну чистоту під CRA/enterprise-DD; фікс NOTICE-drift | свідомо відкладено — не гейтить нічого зараз | 0 |

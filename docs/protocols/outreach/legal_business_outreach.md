...
| `legal/msa_skeleton.md` | Аблязов + той самий крипто-юрист TBD | юр-ревю каркаса + заповнення `[⚖️ TBD]`-полів + фіналізація | підписний B2B MSA (counterparty = ActiveBridge, за BIZ.20-присудом) | перший B2B-підпис | BIZ.20 ✅ · UNI.16-присуд ПЕРЕД підписом · BIZ.21-CoI · BIZ.18-числа · product-redesign (Consistency Gate — §2 п.7) | н/о |

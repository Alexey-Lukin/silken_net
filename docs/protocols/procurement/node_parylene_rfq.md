...
| **Висоти компонентів** | [`02_01 §3.1`](../../02_01_Hardware_Architecture_and_BOM.md) поз. 3 (EDLC горизонтальний, H 5.2 мм) · нога [`00_07`](../../00_07_Action_Plan_Tracker.md) HW.9 і [`02_02 §3.5`](../../02_02_Blind_Mate_Pogo_Pin_Interface.md) (модуль LoRa-E5, 2.5 мм) | «about 5 mm» · «about 2.5 mm» | P/N (Eaton `KR-5R5H474-R`, Seeed LoRa-E5) |
...
- **Components:** SMD parts. The tallest is a horizontal supercapacitor about 5 mm high; the radio module is about 2.5 mm high. The mezzanine connector pair is not selected yet: our leading candidate has a 1.27 mm pitch and a stack height of 8–10 mm, and finer-pitch parts are among the alternatives.

...
> **Два з трьох рішень ухвалено ⚖️ founder 2026-09-17:** `Leu80 → Asp` (нічия в ΔSASA, вирішив заряд) взято, `Ile401 → Ser` **тримається** до перевірки консервативності позиції. Отже послідовність freeze сьогодні = **600 aa · 11 N→Q · L80D · A70S**, а патч Gln405 лишається без компенсації. **Відкрите одне:** прогонити Aggrescan3D (зовнішній вебсервер, 👤) чи зняти цю половину рецепта з названою підставою ([`00_07`](../../00_07_Action_Plan_Tracker.md) HW.5.IS) ([`L1 §2`](../ebfc/in_silico/L1_protein_architecture.md), → [`00_07`](../../00_07_Action_Plan_Tracker.md) HW.5.IS):
...
> ⚠️ **Іонна рідина Шару 2 («IL @ MWCNT»): первинку знайдено, і вона свідчить ПРОТИ шару** — [BMIM][BF₄] нерозведеною плівкою на скловуглеці, без Ti й без Os; її аніон гідролізується до фториду, що руйнує пасивацію Ti при pH ~5, а кріплення «EDC/NHS до TiO₂» без амінного проміжного шару не працює ([`01_03 §2.1`](../../01_03_EBFC_Enzymatic_Bio_Fuel_Cell.md) п.2). ⚖️ Рекомендація — прибрати IL зі шару ([`00_07`](../../00_07_Action_Plan_Tracker.md) HW.5), тож IL тут не закуповується. Трубки закуповуються незалежно від цього присуду.

...
- [ ] 👤 **Spec B (ZIF)** — RFQ або ЧНУ-партнерство ([`00_02`](../../00_02_Academic_Integration_and_IP.md)) паралельно. ЧНУ — ⚖️ 2026-09-23: два питання (синтез · чим підтвердить 40–80 нм і фазу), текст — UA-блок нижче; канал пасивний — один лист, без нагадувань.

...
- [ ] 👤 Усі deliverables → **Stage 2 Ti-coins (HW.24)**: in-vitro CV/EIS у синтетичному ксилемному соку (рецептура — біо-хаб ЧНУ, [`00_02`](../../00_02_Academic_Integration_and_IP.md)), 30-day stability, chloride-tolerance (0.25 М NaCl), UCST winter-lock. Електрод із «вушком» під потенціостат-кліпсу, A=2 см². Лист лабораторії, що це міряє, — [`anchor_coin_electrochem_rfq`](anchor_coin_electrochem_rfq.md).

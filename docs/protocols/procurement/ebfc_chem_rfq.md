...
Йдеться про триметалевий нанозим на основі цеолітного імідазолатного каркаса (ZIF) з кобальтом, міддю та церієм — міметик лакази, що працює як каталізатор відновлення кисню на катоді. Метод — сольвотермальний синтез. Критична вимога — розмір частинок 40–80 нм: більші кристали не утримуються на електроді.
...
2. Чим кафедра може підтвердити розмір частинок 40–80 нм і кристалічну фазу ZIF — скануючою електронною мікроскопією та рентгенівською дифрактометрією власними силами чи через партнерські лабораторії?
...
16. **Критична вимога, якщо ви за це беретесь:** розмір частинок **40–80 нм**; більші кристали не утримуються на електроді, тож цей розмір є умовою договору, а не побажанням. **Чим ви підтвердите розмір і кристалічну фазу** — скануючою електронною мікроскопією та рентгенівською дифрактометрією власними силами, чи через партнерську лабораторію? Повне приймання, яке ми просимо: мікроскопія (розподіл за розміром і морфологія) · дифрактометрія (фаза каркаса) · елементний аналіз співвідношення міді, кобальту й церію · питома поверхня за методом БЕТ.
...
3. **Критична вимога — розмір частинок 40–80 нм.** Це умова договору з контролем електронною мікроскопією, а не побажання: макрокристалічний продукт непридатний, він не утримується на нашому електроді. Цільова морфологія — пориста губчаста структура з агрегованих нанокристалів цього розміру.
...
7. **Мікроскопія:** скануюча електронна мікроскопія з розподілом за розміром і морфологією — **підтвердження діапазону 40–80 нм**.
...
5. **Скануюча електронна мікроскопія — розмір і морфологія.** Нам потрібен розподіл за розміром, а не одне характерне зображення. Просимо запропонувати методику й назвати:
   ...
   Результат просимо подати трьома окремими частинами: **розмір окремих кристалів** (там, де межі між ними розрізняються), **розмір агрегатів**, а також чи є у зразку великі окремі кристали. Для кристалів — гістограма, середнє, медіана, стандартне відхилення й частка поза діапазоном 40–80 нм.

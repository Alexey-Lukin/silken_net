...
>
> ℹ️ **IP:** defensive-publication ([`08_01 §2`](../../08_01_Joint_Publications_and_IP_Strategy.md)) — specs відкриті; CDA = стандартні комерц-умови.
...
- **CV/EIS** у синт. ксилемному соку *Pinus sylvestris* pH 4.5-5.5 ([`08_02 §1`](../../08_02_Academic_Institutions_Registry.md)): j_max, k_s, DET-маржа.
...
**Electrochem-CRO:** **EL-CELL (DE)** — бере клієнтські купони + custom-electrolyte CV/EIS, будує протокол. Альт: ЧНУ/ЧМА co-pub ([`08_02 §2`](../../08_02_Academic_Institutions_Registry.md)).
...
- [ ] 👤 Синт. сік — біо-хаб ЧНУ Спрягайло (рецептура, [`08_02 §1`](../../08_02_Academic_Institutions_Registry.md)).

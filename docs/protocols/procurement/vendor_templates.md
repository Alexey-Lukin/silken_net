...
> **Адресат:** **ІКХХВ НАН України** (Київ) — єдиний названий носій цієї метрології в [`ua_vendor_map §5`](ua_vendor_map.md); ⚠️ **їхні власні мембрани протилежного класу (гідрофільні)**, тож наявна метрологія під наш гідрофобний мікропористий PTFE **не перевірена — лист це й питає**. **Не контактовано.** Форма — **ТЗ українською під договір на науково-дослідну роботу**, бо адресат є установою НАН, а не торговою компанією. Індекс — [`rfq_registry`](rfq_registry.md) §1 рядок «Покриття / біо» · §4.E. ⏳ Станом на 2026-09-21.

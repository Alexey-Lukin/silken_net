...
> **Немає свідомо:** порогу Δ ≤ 5 % як вимоги до адресата (його міряє інший виконавець — §📤 метрології; цей лише проводить цикл) · підтвердження стерильності й грибостійкості (третій адресат) · трекер-ID, канон-рефів і гліфів.
> ⚠️ **Дім тимчасовий:** per-component лист у крос-доменному файлі йде проти конвенції [`rfq_registry §5`](rfq_registry.md) і переїжджає в аркуш «Стерилізація» ([`rfq_registry §1`](rfq_registry.md)), щойно той авториться.

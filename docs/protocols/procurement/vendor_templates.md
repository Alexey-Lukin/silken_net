...
14. **Кількість:** орієнтовно кілька зразків у першій серії, кожен вимірюється двічі (до і після обробки). Чи є мінімальне замовлення.
15. **Ціна:** за один вимір і за серію; окремо — точка бульбашки, тиск входу води, крайовий кут.
16. **Строки:** черга до початку, тривалість виконання, строк повернення зразків і протоколу.
17. **Умови співпраці:** на якій підставі ви надаєте такі послуги стороннім організаціям (договір на науково-дослідну роботу, договір про надання послуг), які документи потрібні від нас і форма оплати.

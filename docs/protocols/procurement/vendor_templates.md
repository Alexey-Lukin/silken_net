...
> **Питає, бо канон цього не несе:** чи бере установа нестандартний протокол і якою формою договору · які саме види з названих родів доступні в їхній колекції й чи є вони депонованими · концентрацію інокуляту й спосіб нанесення на титанову поверхню (канон називає роди, не титр) · середовище й температуру культивування · критерій зчитування росту · чи переживе інокулят транспортування до опромінювача й назад.

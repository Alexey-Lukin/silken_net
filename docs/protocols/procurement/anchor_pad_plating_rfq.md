...
3. **Форма й мова вирішені ДО тексту** (скіл `legal-business`, доменне правило #6): адресат — комерційний цех, тож **лист українською, не ТЗ**. ⚠️ Якщо адресатом стане установа НАН (найближче названий носій — ІЕЗ ім. Патона, і це PVD, тобто інша фізика, ніж гальваніка), оболонку переробити на ТЗ під договір НДР за зразком [`anchor_hip_rfq`](anchor_hip_rfq.md) — зміст той самий. **EN-версії немає свідомо** — пишеться, коли з'явиться адресат у ЄС.

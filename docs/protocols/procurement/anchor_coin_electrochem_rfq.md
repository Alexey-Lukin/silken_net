...
- ⚠️ **Послідовність руйнівних ніг канон не задає** — D і E на тих самих купонах, що й C, чи на окремих репліках. Від цього залежить кількість купонів. ⚠️ Англійський текст листа розкладки НЕ просить — лише ціни за купон і тест, канал-день, кількість каналів і опцію нанесення (A ⊥ B); розкладку пропонуємо ми, рекомендація — [`00_07`](../../00_07_Action_Plan_Tracker.md) HW.24 (§6).

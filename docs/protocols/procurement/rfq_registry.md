...
| **Анкер hardware** | PEEK Zone2/Radome · pogo · O-ring · DIN-471 · болти | [`01_01`](../../01_01_Coaxial_Gyroid_Topology_and_PEEK.md) · [`02_02`](../../02_02_Blind_Mate_Pogo_Pin_Interface.md) · [`07_02`](../../07_02_Unit_Economics_and_BOM.md) §8 | §4.B/§4.C | 🟡 | EU DMLS (3D Lab PL…) **AM** · Mill-Max (pogo) · fastener-**DIST** | HW.1/HW.8/HW.17/HW.23/HW.27/BIZ.6/BIZ.8 |
...
| **Secure Element** | NXP SE050 | [`03_05`](../../03_05_Hardware_Symmetric_Crypto_and_Security.md) §3.7 · [`03_06`](../../03_06_Factory_Flashing_and_Key_Provisioning.md) | §4.D | ⚪ | NXP **DIST** (DNP до FW.2) | SEC.6/ARCH.43 |
| **Стерилізація** | gamma (Co-60) · UV-C · автоклав/EtO послуги | [`01_04`](../../01_04_CODIT_and_Xylemointegration.md) §6 | §4.E | ⚪ | Co-60 (Чорнобиль НДІ / Київ ІРОНЦ) **CRO** | HW.22 |
| **Покриття / біо** | 8-HQ · Zn-HAp · PEDOT:PSS · PTFE-GDL · лігнін | [`01_02`](../../01_02_Ti_6Al_4V_Metallurgy_and_DMLS.md) §3 · [`01_04`](../../01_04_CODIT_and_Xylemointegration.md) §4/§5 | §4.A/§4.E | ⚪ | ЧНУ/ЧМА **ACAD** · Gore/Donaldson (PTFE) **DIST** | HW.4/HW.25/HW.27 |
| **Інструмент монтажу** | step-drill · microfreze (WC+TiN) | [`01_04`](../../01_04_CODIT_and_Xylemointegration.md) §3.1/§3.3 | — | ⚪ | MicroX/OSG **DIST** | HW.6 |
...
| **00_07** | HW.5/HW.24/HW.3 | **BIZ.6** (EU-backup), **BIZ.8** (Frame Agreement-трек) |
...
- **§4.E Стерилізація/мембрана** ([`01_04 §5/§6`](../../01_04_CODIT_and_Xylemointegration.md)): **Co-60 НЕ EtO** (несумісний з PSBMA) · **low-dose 15кГр** для ферментів (НЕ 25, [`01_03 §3.5`](../../01_03_EBFC_Enzymatic_Bio_Fuel_Cell.md)) · PTFE-GDL 0.2-1.0µm.

...
| **Анкер hardware** | PEEK Zone2/Radome · **PEEK-мікротрубка лайнера шини** (ID 1.00 / стінка 0.15; ⚠️ постачальник тримає **ID/OD**, а канон заморозив СТІНКУ — перевиразити парою при запиті, [`00_07`](../../00_07_Action_Plan_Tracker.md) HW.34) · pogo · O-ring · DIN-471 · болти | [`01_01`](../../01_01_Coaxial_Gyroid_Topology_and_PEEK.md) · [`02_02`](../../02_02_Blind_Mate_Pogo_Pin_Interface.md) · [`00_04 §8`](../../00_04_Nature_as_a_Service_Contracts.md) | §4.B/§4.C | 🟡 | EU DMLS (3D Lab PL…) **AM** · Mill-Max (pogo) · fastener-**DIST** · PEEK-tube extruder **DIST** | HW.1/HW.8/HW.17/HW.23/HW.27/HW.34/BIZ.6 |
...
| **Покриття / біо** | 8-HQ · Zn-HAp · PEDOT:PSS · PTFE-GDL · лігнін | [`01_02 §3`](../../01_02_Ti_6Al_4V_Metallurgy_and_DMLS.md) · [`01_04 §4`](../../01_04_CODIT_and_Xylemointegration.md) · [`01_04 §5`](../../01_04_CODIT_and_Xylemointegration.md) | §4.A/§4.E | ⚪ | ЧНУ/ЧМА **ACAD** · Gore/Donaldson (PTFE) **DIST** | HW.4/HW.25 · **HW.40** (Zn-HAp · PEDOT:PSS · лігнін — біоміметичні покриття відколото від HW.6 2026-07-16; ⛔ НЕ HW.27, той про вакуумний відпал) |
...
- **§4.C Анкер механіка** ([`01_01 §3/§4.2/§4.3`](../../01_01_Coaxial_Gyroid_Topology_and_PEEK.md)): PEEK annealing 200-250°C перед фрезеруванням · H7/s6 hex ≤0.05мм · barbs (3-5 рядів, h0.28/α30/β70, self-support) · DIN-471 external · press-fit 150°C/800-1200Н.
  ⊕ **PEEK-мікротрубка лайнера шини — питати ПАРУ смуг ID і OD, а не стінку, і причина в тому, що смуги судять ДВІ РІЗНІ посадки** ([`00_07`](../../00_07_Action_Plan_Tracker.md) HW.34). Канон заморозив **стінку 0.15 мм**, якої екструзійний процес не тримає — постачальник тримає ID і OD, — тож запит мусить перевиразити дим парою. **Смуга ID** судить пару «канал трубки ↔ дріт Ø1.0»: сума її з допуском самого дроту має вміститись у **21.3 мкм діаметрально** (вікно між «фіт лишається фітом на гарячому краю» і плинністю PEEK на холодному, `tools/in_silico/cache/mechanical/bus_mechanical.json` §`interference_window`); ширша сума означає, що ратифікований натяг **не купується** — його доведеться добирати селекцією, механообробкою або гарячою посадкою. **Смуга OD** судить пару «трубка ↔ механооброблений канал катода Ø1.35», де номінал лишає 50 мкм діаметрально на ДВІ стінки. ⛔ **Номінального натягу в запиті НЕ називати** — він відкритий ⚖️ ([`00_07`](../../00_07_Action_Plan_Tracker.md) HW.34); питаємо смуги, а не підтвердження нашого числа.

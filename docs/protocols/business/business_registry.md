...
| [`carbon_registry_matrix.md`](carbon_registry_matrix.md) | Порівняння carbon/biodiversity-реєстрів + метрологічний розрив | [`07_01 §3`](../../07_01_Nature_as_a_Service_Contracts.md) (фін-константи) · [`02_06 §7.3`](../../02_06_Unit_Economics_and_BOM.md) | **BIZ.9** (вибір реєстру = ⚖️) |
...
| [`carbon_integrity_standards.md`](carbon_integrity_standards.md) | Buyer-side integrity-стек: ICVCM CCP, VCMI, Oxford, SBTi, ISO 14064, IAPB | [`02_06 §7.1`](../../02_06_Unit_Economics_and_BOM.md) (growth_points → CO₂-еквівалент) · [`07_01 §3`](../../07_01_Nature_as_a_Service_Contracts.md) | **BIZ.9** / **BIZ.23** (biodiversity = stewardship, не offset) |

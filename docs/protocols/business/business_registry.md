...
> **Що це:** індекс **робочих бізнес-артефактів** SilkenNet. Периметр — **УСІ** рядки таблиці нижче, а не якийсь їх рід: SLA-exhibit · carbon/biodiversity-реєстри · страхова спека · enterprise-readiness · integrity- та OSS/Web3-стандарт-ландшафти · **outreach-dispatch-карта** (⚠️ доти опис її не називав, тобто рядок був невидимий тому, хто читає лише опис — той самий дефект, що закрито в [`legal_registry`](../legal/legal_registry.md) 2026-09-07; ⛔ і саме тому тут немає числа) — один рядок на артефакт: про що, чий канон він дзеркалить, де живе його стан.
...
| [`../outreach/forest_access_application.md`](../outreach/forest_access_application.md) | Заявка на доступ до ділянки під дослідження (Черкаський бір): що каже первинка про форму документа, адресат, опис робіт, текст за зразком ДСГП | [`01_04 §5.5`](../../01_04_CODIT_and_Xylemointegration.md) (тест захисту) · [`01_02 §2.2`](../../01_02_Ti_6Al_4V_Metallurgy_and_DMLS.md) (тензодатчик) | **HW.28** · HW.43 |
| [`../outreach/lock_fea_prony_brief.md`](../outreach/lock_fea_prony_brief.md) | Бриф-запит на FEA утримання замка + Prony-фіт крипу PEEK — для партнера або комерційного виконавця; текст запиту UA під ЧНУ — §9 (copy-region) | [`01_01 §4.3`](../../01_01_Coaxial_Gyroid_Topology_and_PEEK.md) · [`00_03 §3`](../../00_03_TRL_Matrix_HIL_and_Beyond.md) | **HW.26** |
| [`../outreach/owner_meeting_briefs.md`](../outreach/owner_meeting_briefs.md) | One-pager підготовки до зустрічей: UA-юр-review (Аблязов, СЄУ) · Data Science (Карапетян, ЧДТУ) — asks, framing, next | [`00_02 §4.2`](../../00_02_Academic_Integration_and_IP.md) (юр-предмети) · [`00_01 §8`](../../00_01_Vision_Mission_and_Roadmap.md) (IP) | **UNI.14** · UNI.9 |
| [`../outreach/tax_advisor_shortlist.md`](../outreach/tax_advisor_shortlist.md) | Публічний шортлист на ЧЕТВЕРТУ вакансію (податковий фахівець): кандидати · вимірювачі 90%-тесту · академ-канал · рекомендація-вхід для присуду | [`00_02 §4.2`](../../00_02_Academic_Integration_and_IP.md) (роль) | **UNI.14** · BIZ.20 |
| [`../outreach/advisor_fee_requests.md`](../outreach/advisor_fee_requests.md) | Тексти запитів оцінки вартості (copy-регіони): податковий фахівець · крипто/securities-юрист UA і EU · патентні повірені — адресатів обрано ⚖️ 2026-09-26; жодного не надіслано | [`00_02 §4`](../../00_02_Academic_Integration_and_IP.md) (ролі й предмети) | **UNI.14** · UNI.16 · UNI.15 |
| [`../outreach/mindovkillia_article6_request.md`](../outreach/mindovkillia_article6_request.md) | Заготовка запиту до нац-focal-point (Article 6 / double-counting) + ⛔ присуд про момент: відкладено з тригером | — (предметні факти — `carbon_registry_matrix` §3, `carbon_integrity_standards`) | **BIZ.9** |

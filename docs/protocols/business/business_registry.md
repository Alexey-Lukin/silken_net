...
| [`../outreach/lock_fea_prony_brief.md`](../outreach/lock_fea_prony_brief.md) | Бриф-запит на FEA утримання замка + Prony-фіт крипу PEEK — для партнера або комерційного виконавця | [`01_01 §4.3`](../../01_01_Coaxial_Gyroid_Topology_and_PEEK.md) · [`00_03 §3`](../../00_03_TRL_Matrix_HIL_and_Beyond.md) | **HW.26** |

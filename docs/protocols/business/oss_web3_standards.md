...
- 🟢 **Зараз (дешева частина):** (а) ✅ DOC-T.47 — закрито; (б) ✅ scope-присуд ухвалено; (в) ✅ mass-кампанія виконана (але після scope-рішень її можна їхати per-дерево між справами). REUSE lint як CI-advisory — після кампанії, не до.

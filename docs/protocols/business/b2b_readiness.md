...
11. **DR-drill — ПОВНИЙ цикл** (#9; дім DR.1) — drill №1 виконано 2026-09-02 (§5.1 повністю, §5.2 наполовину; результат — [`06_06 §6`](../../06_06_Disaster_Recovery_and_Backup.md)); лишається §5.2 у повній формі (`terraform apply` з витягнутої версії на throwaway-стеку) + §5.3–5.6 за drill-процедурою + 1-pager «BC/DR summary» (master-key-backup чекбокс — окремий, deploy-time).

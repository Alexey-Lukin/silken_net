...
1. ⏸️ **Прямий запит нац-focal-point** (Article-6 VCM-authorization, §3.3) — ⛔ **ВІДКЛАДЕНО ⚖️ founder 2026-08-29, не брати в роботу** ([`00_07`](../../00_07_Action_Plan_Tracker.md) BIZ.9): три з чотирьох питань належать ОПЕРАТОРУ, а не нам (ратифікований трек §1.3 робить нас dMRV-постачальником даних), і «0 грн» правдиве лише в одній валюті — звернення від проєкту на TRL 3 лишає ранній слід. Наше питання тут рівно одне: чи поширюються вимоги на постачальника даних.

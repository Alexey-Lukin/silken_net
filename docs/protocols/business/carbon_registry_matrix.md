...
>
> **Джерела:** [`R3_carbon_registries.md`](../research/R3_carbon_registries.md) (carbon, несучий metrology-gap) · [`R4_biodiversity_credits.md`](../research/R4_biodiversity_credits.md) (biodiversity both/and). **Канон:** [`07_01 §3`](../../07_01_Nature_as_a_Service_Contracts.md) (фін-константи, 2000 SCC = 1 tCO₂) + [`07_01 §2`](../../07_01_Nature_as_a_Service_Contracts.md) (Puro death-path) · [`07_02 §7`](../../07_02_Unit_Economics_and_BOM.md) (unit-economics; SCC = «Silken Carbon/**Condition** Coin») · [`00_07`](../../00_07_Action_Plan_Tracker.md) BIZ.9 / BIZ.1 / ARCH.5 · дотично [`05_02`](../../05_02_Proof_of_Growth_Pipeline.md) (Proof-of-Growth), [`05_05 §3.2`](../../05_05_Slashing_and_Risk_Policy.md) (chainsaw_detected/SLASH-1), [`03_03`](../../03_03_TinyML_Acoustic_Inference.md) (TinyML 5-клас).
>
...
1. SCC — насамперед **Condition/homeostasis-токен**. Це прочитання **вже латентне в каноні** ([`07_02 §7`](../../07_02_Unit_Economics_and_BOM.md): «SCC (Silken Carbon/**Condition** Coin)») — треба на нього спертися, а не на «Carbon» половину.
...
- SCC = **Condition/Proof-of-Growth-токен** (homeostasis), не сертифікований tCO₂e. Спертися на «Condition Coin»-прочитання (вже в каноні [`07_02 §7`](../../07_02_Unit_Economics_and_BOM.md)).

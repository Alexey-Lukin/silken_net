...
| **D — Compliance / Legal** | Юриспруденція, регуляторика, IP, B2B, операційні SOP | Polygon Hadron (ERC-3643), MSA з СЄУ, Verra / Gold Standard методологія, GDPR / ESG звітність, IP-постава (defensive publication + open-license), аварійні SOP | **СЄУ** (Аблязов — UA-legal рамка, Чудаєва/Ус — економіка/моделювання, Гедз — фінанси; D-MRV/крипто-специфіка → профільні TBD [`08_02 §5`](08_02_Academic_Institutions_Registry)), **ЧІПБ** (пожежна безпека, SOP, параметричне страхування [`08_02 §3`](08_02_Academic_Institutions_Registry)) |

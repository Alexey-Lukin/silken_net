...
**Науковий профіль:** Телекомунікації, радіотехнічні системи, електромагнітна сумісність, антенні системи
...
**Базіло К.В.:** Доктор технічних наук, професор. П'єзоелектричні перетворювачі, акустоелектроніка, мехатроніка.
**Бондаренко М.О.:** Доктор технічних наук, професор. Мікродеформації, прецизійне приладобудування, акустичні вимірювання.
...
Параметри вимірювань:
  1. Імпедансна характеристика п'єзосенсора при T = -20°C..+50°C
  2. Чутливість у діапазоні 25–150 кГц (резонансні частоти, АЧХ)
  3. Вплив вологості та тиску середовища (імітація ксилемного соку)
  4. Рекомендації щодо оптимального типу/розміру п'єзоелемента
     для детекції кавітаційних мікроемісій через титановий хвилевід
```

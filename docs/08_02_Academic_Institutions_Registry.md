...
Економіка/право. **Diff від Кирилюка (ЧНУ):** СЄУ = прикладний макро-стрес-тест + legal wrapper; Кирилюк — фундаментальна біоекономічна рамка. (Дизайн — self.)

| Партнер | Роль | Що валідує → канон-дім | Публ. |
|---|---|---|---|
| **Чудаєва І.Б.** (Ія Борисівна, ректор СЄУ) | інституційний якір / регіональна економіка | Д.е.н.; ректор-підписант MoU; технополіси, наукові парки, регіональна інноваційна економіка, HR-менеджмент | Ст. 31/35 |
| **Ус Г.О.** (Галина Олександрівна, проф. каф. економіки) | цифрова економіка / матем. моделювання | Д.е.н.; математичні методи та ІТ в економіці; цифрова економіка (2021); управління знаннями (2024) | Ст. 31 |
| **Аблязов Д.Е.** (Денис Едуардович, віцепрезидент СЄУ) | комерційне право / legal-risk | к.ю.н. (син засновника СЄУ); господарське/комерційне право, протидія корпоративному рейдерству (2021), інвестиції → MSA/MoU/інкорпорація-counterparty ([`00_07` BIZ.2/BIZ.20](00_07_Action_Plan_Tracker)); крипто-специфіка (MiCA/ERC-3643) → профільний TBD → [`07_01`](07_01_Nature_as_a_Service_Contracts), [`05_06`](05_06_Governance_and_DAO) | Ст. 32/35 |
| **Гедз М.Й.** (проректор з якості) | фінанси / облік криптоактивів | Д.е.н., проф. (ex-ЧДТУ); регіональна економіка, фінансовий облік криптоактивів в Україні (2025), якість/акредитація (ISO 9001) | Ст. 31/32 |

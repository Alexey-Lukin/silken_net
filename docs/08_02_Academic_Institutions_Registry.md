...
| ВНЗ | Ніша |
|---|---|
| **ЧНУ** | фізика/хімія/біологія + кібернетика/ПЗ/радіо |
| **ЧДТУ** | дані/моделі, RF-виміри, акустика, прецизійна механіка |
| **ЧІПБ** | пожежна безпека, ДСНС-міст |
| **ЧМА** | біомедична валідація EBFC, токсикологія |
| **СЄУ** | макроекономіка токеноміки, RWA-право, фінансовий облік |

...
Зведений **реєстр академічних партнерів** (5 університетів) — хто, яка кафедра, що валідує і куди веде вихід. Інженерна субстанція їхніх deliverable'ів **живе в каноні Tier I (01–06)** і **реферується** звідси, а не дублюється. План публікацій та IP-рамка — [`08_01`](08_01_Joint_Publications_and_IP_Strategy); зовнішні (B2G/B2B) стейкхолдери — [`08_03`](08_03_External_Stakeholders_Registry).

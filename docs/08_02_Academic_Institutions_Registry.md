...
| доц. **Ярмілко А.В.** (ФОТІУС) | IIoT / embedded / lightweight crypto | Engaged partner (зустрічі 2026, вхід у ректорат); airtime↔CCM tradeoff = spot-check нашого self-own розрахунку (Ст.23), не незалежна валідація; SPI/DMA-консультація ([`00_07` E.9](00_07_Action_Plan_Tracker) — Open-Research); far-horizon PQC | Ст. 23/24 |

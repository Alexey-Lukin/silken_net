...
| **Порубльов І.М.** | дискретна математика, обчисл. геометрія | mesh percolation/Markov `q_c` ([`06_08`](06_08_Resilience_and_Failover_Policy)) — ⚠️ **відкладено** (mesh star-only post-CCM; повернення ARCH.43 post-TRL 6); **ARCH.74 Monte-Carlo TTL-justification self-owned 07-20** (як ARCH.25/Lorenz — machine наша, percolation-теорія = двері). Валідація TPMS-геометрії ([`01_01`](01_01_Coaxial_Gyroid_Topology_and_PEEK)) — self-owned **ARCH.25** (`tools/cad`); Lorenz-аудит **self-own стався** ([`05_05 §6`](05_05_Slashing_and_Risk_Policy), 50 000 parity-тестів). **Жива ланка = пороги гейта + numeric-DCI (Ст.25 + Ст.34, Z-пороги)** | Ст. 25/34 живі · Ст.3 mesh self-own |
| доц. **Косенюк Г.В.** | військова радіотехніка, теорія кодування | RF impedance/Link Budget/ground-plane ([`02_01 §5`](02_01_Hardware_Architecture_and_BOM)); енерго-свідомий вибір coding-rate ([`00_07` FW.61/E.15](00_07_Action_Plan_Tracker)). ⚠️ «FEC» знято 2026-07-17 — E.15 ⚫ (CR 4/5 Hamming уже в кремнії SX126x); **«Hash Method» знято 2026-07-20 — vacuous** (0 артефакту, дублює QATT/MIC/Merkle; крипто-хеш ≠ його RF/coding фах) | Ст. 23 |

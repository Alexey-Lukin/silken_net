...
| **Ротар В.** | SOP | 8 SOP-документів per alert_type (field ops) → [`00_07` ARCH.31/UNI.12](00_07_Action_Plan_Tracker) (дім; SOP-compliance = зворотний бік Кат-A negligence-evidence для slashing). ⚠️ Дім виправлено 2026-07-17: було [`08_03`](08_03_External_Stakeholders_Registry), де «SOP»/«forester» = 0 входжень | Ст. 26 |
...
| **Теліженко О.В.** (Олександра) | етнодизайн / UX | Народний художник України (етнодизайн, монументальне мистецтво). Орнаментальний патерн-бренд: «Silken Net» = текстильна метафора, mesh-топологія що обплітає бір ≈ рушник-оберіг → [`04_04`](04_04_Phlex_UI_and_Tailwind) (Phlex UI motifs), [`02_05`](02_05_Queen_Hardware_and_Starlink) (Queen radome graphics); Genesis NFT-трек → [`08_03`](08_03_External_Stakeholders_Registry). ⚠️ Ст.33-ланка «selection super-hydrophobic coating» — **хибна атрибуція** (фторполімерна хімія ≠ її фах; присуд по coating = founder, [`00_07` HW.28](00_07_Action_Plan_Tracker) ⚖️) → склад Ст.33 потребує перегляду | 08_03 / [`04_04`](04_04_Phlex_UI_and_Tailwind) |

...
> 🔴 **Наступний виток тієї самої осі, і він поза межами токенів узагалі: питання не «ЯКА з наших монет», а «чи це взагалі наша монета»** ([`TEST.12`](00_07_Action_Plan_Tracker), 2026-08-11). Попередня хвиля розводила SCC ⊥ SFC — два наші токени; тут розійшлись **токен і фіат**. `NaasContract#total_funding` (та його alias `total_value`, і похідний `Organization#total_contracted`) — це «сума оплати за послугу (USDC/USD)» за [`07_01 §5`](07_01_Nature_as_a_Service_Contracts), і вся юніт-економіка [`02_06 §1`](02_06_Unit_Economics_and_BOM)–[`§10`](02_06_Unit_Economics_and_BOM) рахує її в доларах. UI підписував цю величину карбоновим тікером на **сімох** сайтах — реєстр організацій, картка організації, реєстр контрактів (значення І заголовок колонки), hero-рядок картки контракту, обидва фінансові звіти. Тобто інвесторові показували плату за послугу як емісію.
>

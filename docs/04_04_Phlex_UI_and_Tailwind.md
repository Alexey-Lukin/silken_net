...
> - **Індикатор і кнопка — одна зміна.** Кнопка без індикатора створює стан «дивлюсь чужі дані, і на екрані про це нічого», а `DashboardLayout` `flash` не рендерить, тож іншого каналу підтвердження не існує.
>

...
- **Відкрите:** production verification (UI на живому деплої) → [`09_06`](09_06_Action_Plan_Tracker).
...
| [09_06_Action_Plan_Tracker](09_06_Action_Plan_Tracker) | Open backlog (UI verification, i18n) |
...
| `Codex::Attunements::Toggle` | `codex/attunements/toggle.rb` | `node:`, `current_user_attuned:`, `count:` | **Phase 2.** Кнопка "Attune"/"Attuned" + лічильник. POST/DELETE на nested-route. Лічильник оновлюється виключно через Turbo Stream broadcast (Solid Cable target `codex_node_<id>_attunement_count`) — без Stimulus optimistic UI (ADR в [`04_05 §3.1 Phase 6`](04_05_Codex_Lore_Module): `codex--attune` видалений як over-engineering). |

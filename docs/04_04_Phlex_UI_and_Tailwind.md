...
**Тема перемикається РІВНО однією шафою — класом `.dark` на `<html>`**, і ставить його FOUC-скрипт у `dashboard_layout` **виключно за `prefers-color-scheme`**. Світла = відсутність класу. Механіка того, чому шафа саме одна, — §3.

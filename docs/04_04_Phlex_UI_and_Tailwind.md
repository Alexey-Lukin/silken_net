...
⚠️ **Морф і flash:** вузол, якого немає у свіжій відповіді, Idiomorph видаляє — але Turbo **перехоплює** це, підставляючи власний колбек (`beforeNodeRemoved = node => this.beforeNodeMorphed(node)` → cancelable `turbo:before-morph-element`, гард `instanceof Element`). Тобто утримати повідомлення через морф **можливо**, і для наших регіонів навіть простіше: вони рендеряться завжди, тож при морфі мають пару й подія приходить штатним шляхом. ⛔ **Але утримувати його ми свідомо НЕ будемо (won't-do 2026-08-01):** редиректів «на ту саму адресу» серед усіх flash-сайтів рівно три, і flash на morph-підписаній сторінці садять два рядки одного контролера. (⚠️ Загальне число сайтів тут навмисно не називається — воно дрейфує з кожною хвилею: Ф3+Ф4 додали чотири нові; несуча величина — саме «три same-location», і вона від них не змінилась.) Гард ще й виробляв би БРЕХЛИВЕ підтвердження при роботі пачкою (утримана плашка першої дії лишалась би за другу) і осідав у кеші снапшотів, тобто «Назад» оголошував би дію десятихвилинної давнини. Повний розбір пʼятьох підстав → [`00_07`](00_07_Action_Plan_Tracker) SEC.25. Канал підтвердження на таких сторінках — **СТАН** (як `Alerts::Row` уже робить), не повідомлення.

...
| `AccountSecurity` | `Show`, `MfaSetup` | `Show` — `user:`; `MfaSetup` — `user:` + `error:` (422 verify-коду на місці; QR — інлайн-SVG rqrcode з нашого ж `otp_provisioning_uri`, CSP-чистий) [S6.21] |

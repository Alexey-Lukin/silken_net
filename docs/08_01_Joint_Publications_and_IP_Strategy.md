...
| [`08_02 §1`](08_02_Academic_Institutions_Registry) | ЧНУ — Hard Science (§1A: фізика/хімія/біологія) + ФОТІУС (§1B: mruby-Lorenz-аудит + GA/NSGA-II ML) | Лабораторні протоколи + матем. основа Статей 1–3, 23–25, 34 |
...
| **ФОТІУС (cybernetics)** | Порубльов, Ярмілко, Косенюк, Бушин, Любченко | Firmware, math, RF, GA | Статті 3, 23, 24a, 25, 34 |
...
- Подав заявки до чотирьох Web3-фондів (peaq, IoTeX, Chainlink, Filecoin)
...
> ⚠️ **Чесність pitch'а (2026-07-17):** рядки вище раніше казали «**залучає** Web3-фінансування» і «**готовий** R&D-полігон». Перше: всі 4 заявки = статус «Подано», відповідей нема ([`07_03`](07_03_Grant_Applications_Tracker)). Друге: anchor/EBFC = TRL 3, польового стенду ще нема ([`00_03`](00_03_TRL_Matrix_HIL_and_Beyond)) — «робочий стек» = backend TRL 8 + firmware TRL 6 + in-silico Zero-Lab, і цього досить. Обидва overclaim'и валяться від **одного** уточнювального питання в кабінеті — не казати того, що не витримає перепитування.

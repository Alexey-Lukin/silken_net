...
| **СЄУ** | Business | Регіональна економіка + макро-рамка SCC (Чудаєва), UA-юрисдикційна правова рамка RWA (Аблязов Д. — глибока MiCA/крипто → профільний TBD), фінансово-економічна експертиза (Гедз, Ус — моделювання; D-MRV/ESG-аудит → профільний TBD); інфраструктурні ролі: графдизайн/бренд-патерн (Денисенко — [`04_04`](04_04_Phlex_UI_and_Tailwind); промдизайн радому → self/TBD), етнодизайн/UI-патерн (Теліженко — [`04_04`](04_04_Phlex_UI_and_Tailwind)) | [`08_02 §5`](08_02_Academic_Institutions_Registry) | [§1F](#-1f-публікації-сєу-токеноміка-право) |
...
> **Контекст:** ЧМА (Черкаська медична академія) забезпечує токсикологічну оцінку вивільнення іонів V/Al з Ti-6Al-4V (Суховий) та фітотоксикологію self-healing покриттів (Глущенко); фарм-технологію стабілізації ферментів у матрицях (Бушуєва — дотично, не глибока ензимологія → профільний біохімік). ЧМА = навчальний коледж, не матеріалознавча лабораторія; ректор Губенко + проректор Боєчко = інституційний доступ, не наукові автори. Повний реєстр задач — у [`08_02` — Academic Institutions Registry](08_02_Academic_Institutions_Registry).
...
| Автор | Внесок |
|-------|--------|
| **Бушуєва І.В.** (ЗДМФУ, стейкхолдер ЧМА) | Фарм-технологія стабілізації активних речовин у гель-матрицях + регуляторна валідація (дотично до Genipin-Chitosan-CNC immobilization). ⚠️ Глибока EBFC-ензимологія (in vitro лакказа/Nafion, 30-day тест) — не її фах (фармтехнолог/економіст), потребує профільного біохіміка/електрохіміка |
| **Мінаєв Б.Ф.** (ЧНУ) | Строгий DFT interfacial charge-transfer крізь нативний TiO₂ passive-шар (строге закриття грубого oxide-DET script-53) + carboxyl-MWCNT/TiO₂ EDC-NHS кон'югація |
...
| Автор | Внесок |
|-------|--------|
| **Чудаєва І.Б.** (СЄУ) | Регіонально-економічна рамка + інституційна валідація макромоделі SCC-ринку (стрес-тест dual-token = наша Monte-Carlo-симуляція власного контракту, self-owned; профіль = регіонально-інноваційна економіка, не монетарна макра) |
| **Ус Г.О.** (СЄУ) | Економіко-математичне моделювання + управління знаннями. ⚠️ ESG-Accounting Framework = наша потреба, не її документований профіль |
...
| Автор | Внесок |
|-------|--------|
| **Аблязов Д.Е.** (Денис Едуардович, СЄУ) | UA-юрисдикційна правова рамка RWA (Лісовий Кодекс / ПЗФ / ЗУ «Про віртуальні активи»); NaaS Term Sheet + MSA шаблони. ⚠️ Глибока MiCA/ERC-3643/ONCHAINID-специфіка — не його фах (конституційне/міжнародне право), потребує профільного крипто-юриста |
| **Гедз М.Й.** (СЄУ) | Загальна фінансово-економічна експертиза. ⚠️ D-MRV мапінг на Verra VM0003/VM0047 + ISO 14064/ICROA — не його фах (фінанси регіональної модернізації); профільний carbon-методолог → [`00_07` BIZ.9](00_07_Action_Plan_Tracker) |
...
| **Біо-хаб** | О.В. Спрягайло (проректор з науки), М.В. Гаврилюк (директор ННІ природничих наук) | Координація дендрологічного, фітоценологічного та зоологічного блоку; ПЗФ-сумісність pilot'у; ground-truth для Mongabay-pivot | Стаття 24a (Mongabay), Стаття 29 (токсикологія), Стаття 35 (біоекономіка) |
| **Хімія наноматеріалів** | Б.Ф. Мінаєв, В.О. Мінаєва | DFT/TDDFT моделювання EBFC та TiO₂ | Стаття 1 (EBFC), Стаття 28 (біохімія EBFC) |
| **Фізика твердого тіла** | А.М. Гусак | Кіркендалл, Arrhenius, FEM | Стаття 2 (тонкокорозія), Стаття 29 (токсикологія) |
...
| **Гаврилюк М.В.** | ЧНУ біо-хаб | GIS/remote-sensing прив'язка регіонального інвентарю дендрофлори |
| **Чудаєва І.Б.** | СЄУ | Регіонально-економічна рамка (cross-ref зі Статтею 31); supply/demand SCC у регіональному масштабі |
| **Аблязов Д.Е.** | СЄУ | UA-юрисдикційна правова рамка лісових RWA + сумісність із режимом ПЗФ (cross-ref зі Статтею 32; глибока ERC-3643/MiCA → профільний крипто-юрист) |
| **Гедз М.Й.** | СЄУ | Загальна фінансово-економічна експертиза (ISO 14064 / ICROA mapping → профільний carbon-методолог, [`00_07` BIZ.9](00_07_Action_Plan_Tracker)) |
...
| **Магістерська** | "UA-правові аспекти токенізації Real World Assets (Лісовий Кодекс / ПЗФ)" | Аблязов Д. (Денис Едуардович) |
| **Бакалаврська** | "Графічний дизайн і фірмовий стиль антивандальної капсули для лісового IoT" | Денисенко (Юрій Миколайович) |

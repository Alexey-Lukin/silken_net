...
| **СЄУ** | Business | Макроекономіка SCC-ринку (Чудаєва), правова архітектура RWA / MiCA / ERC-3643 (Аблязов Д.), ISO 14064 / ICROA D-MRV аудит (Гедз), unit-економіка та ESG-Accounting (Ус), промисловий дизайн PEEK-радому з **anti-overgrowth shield** (Денисенко); етнодизайн/UI-патерн (Теліженко — [`04_04`](04_04_Phlex_UI_and_Tailwind)) | [`08_02 §5`](08_02_Academic_Institutions_Registry) | [§1F](#-1f-публікації-сєу-токеноміка-право-промисловий-дизайн) |
...
| [`08_02 §1`](08_02_Academic_Institutions_Registry) | ЧНУ — Hard Science (§1A: фізика/хімія/біологія) + ФОТІУС (§1B: mruby-Lorenz-аудит + GA/NSGA-II ML) | Лабораторні протоколи + матем. основа Статей 1–3, 23–25, 28–30, 33–35 |
...
| **Фізика твердого тіла** | А.М. Гусак | Кіркендалл, Arrhenius, FEM | Стаття 2 (тонкокорозія), Стаття 29 (токсикологія), Стаття 30 (FEM термо-механіка Ti↔деревина), Стаття 33 (PEEK FEM) |
...
| **Бакалаврська** | "UX-дизайн B2B дашборду для ESG-інвесторів" | ⚖️ керівник відкритий ([`00_07` UNI.19](00_07_Action_Plan_Tracker)) — Теліженко = **етнодизайн/монументальне мистецтво**, не product-UX |

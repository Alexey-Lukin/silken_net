...
| **СЄУ** | Business | Макроекономіка SCC-ринку (Чудаєва), правова архітектура RWA / MiCA / ERC-3643 (Аблязов Д.), ISO 14064 / ICROA D-MRV аудит (Гедз), unit-економіка та ESG-Accounting (Ус), промисловий дизайн PEEK-радому з **anti-overgrowth shield + super-hydrophobic surface** (Денисенко, Теліженко) | [`08_02 §5`](08_02_Academic_Institutions_Registry) | [§1F](#-1f-публікації-сєу-токеноміка-право-промисловий-дизайн) |

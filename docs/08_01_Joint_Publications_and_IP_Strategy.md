...
> **Принцип:** Де ЧНУ ФОТІУС створює алгоритм або модель — ЧДТУ статистично валідує та розширює. Де ЧНУ ФОТІУС виконує аналітичний розрахунок (RF, фільтри) — ЧДТУ (ФЕТР, ПМКТ) верифікує лабораторно. Самі зони перетину = §1C/§1G нижче.
...
|---------|---------|---------------------|-------------|
| **Парасоль ректорату** | Є.М. Кирилюк (в.о. ректора) | Підпис парасольового MoU ЧНУ↔Silken Net; інституційна координація з ректорами ЧДТУ / ЧІПБ / ЧМА / СЄУ; Triple Helix governance ([`08_02 §5`](08_02_Academic_Institutions_Registry), [`07_03`](07_03_Grant_Applications_Tracker)) | Стаття 35 (біоекономіка) |
...
| **ФОТІУС (cybernetics)** | Порубльов, Ярмілко, Косенюк, Бушин, Любченко | Firmware, math, RF, GA | Статті 3, 23, 24a, 25 |

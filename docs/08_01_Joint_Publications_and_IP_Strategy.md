...
| [`08_02 §1`](08_02_Academic_Institutions_Registry) | ЧНУ — Hard Science (§1A: фізика/хімія/біологія) + ФОТІУС (§1B: формальна верифікація, mruby Lorenz) | Лабораторні протоколи + матем. основа Статей 1–3, 13 |
...
|---|---|---|
| Комп'ютерні науки | "Енерго-свідомий вибір параметрів LoRa-лінку (CR/SF) для star-кластера" | Ярмілко |
...
| Рівень | Тема |
|--------|------|
| **Магістерська** | "Побудова функції корисності для Edge AI IoT-агентів" |

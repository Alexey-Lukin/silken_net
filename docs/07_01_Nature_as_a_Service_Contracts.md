...
**Умови входу:**
- Реєстрація через OAuth2 (**Google** — єдиний провайдер, ⚖️ 2026-08-21; дім переліку `Identity::SUPPORTED_PROVIDERS`, тут НЕ дублюється; OmniAuth-флоу ще без дроту → [`00_07`](00_07_Action_Plan_Tracker) ARCH.69) або стандартна автентифікація (argon2id).

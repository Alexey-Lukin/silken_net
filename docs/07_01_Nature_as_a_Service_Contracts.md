...
> 3. **Пілотна реєстрація — гейтована ПАРТНЕРОМ-ЛІСОКОРИСТУВАЧЕМ, якого ще немає** ([`00_07` BIZ.11](00_07_Action_Plan_Tracker) тримає це відкритим ⚖️-чекбоксом разом із кадастром / biomass appraisal). 🔴 Виправлено 2026-08-10: тут стояло «одна ділянка Черкаського бору / ПЗФ **за двостороннім меморандумом ЧНУ + СЄУ**» — твердження, хибне за трьома незалежними осями. Меморандум **не підписаний** (ЧНУ-MoU у режимі `passive`); з СЄУ MoU **не планується взагалі** за власним режимом контрактації ([`07_03 §1`](07_03_Academic_Integration_and_IP): «СЄУ = персональні контакти, MoU = порожній overhead»); і головне — **обидва є ВНЗ, а не розпорядниками лісу**, тож їхня угода не дає прав на ділянку ПЗФ у жодній конфігурації. Кроки 1-2 вище лишаються чинними, бо описують те, чим ці канали справді є — **юридична експертиза**, не земельний титул.

...
- **Охоплені фреймворки:**
  ...
  - Foundry (Solidity)
- **Відкрите:** test-coverage gaps / відкриті ризики (§B.4) → [`00_08`](00_08_Action_Plan_Tracker).
...
| [00_08_Action_Plan_Tracker](00_08_Action_Plan_Tracker) | Open backlog (coverage gaps, §B.4) |

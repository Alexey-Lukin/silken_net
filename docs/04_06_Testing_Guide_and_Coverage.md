...
Стабити можна те, що вимагає зовнішніх ресурсів (`rails_blob_path` до реального блоба);
маршрут-хелпер до таких **не належить** — у Phlex-спеках він працює по-справжньому
(доведено: після зняття стабів усі приклади лишились зелені).

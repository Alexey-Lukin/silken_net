...
|---|---|---|
| успіх мутації | `redirect_to …` | Rails сам віддає **303** для non-GET; `flash[:notice]` переживає редирект |

...
> ⚠️ **Секції тут не було взагалі — формат жив ЛИШЕ в комерційному [`07_01`](07_01_Nature_as_a_Service_Contracts).** Це той самий клас, що вже кусав на `financial_summary` ([`ARCH.90`](00_07_Action_Plan_Tracker)): формат, який ніде не описаний, нема з чим звірити, тож розходження коду й обіцянки нічим виявити. Заведено разом зі зміною контракту [ARCH.84].

...
### 7.1. Механізм накопичення growth_points

Кожне пробудження Soldier надсилає 1 пакет із полем `StatusByte[5:0]` = growth_points (6 біт, 0–63).

| Параметр | Значення |
|---|---|
| Packets / day (гомеостаз, 1 пакет/год) | **24** |
| GP / packet (при Z ≈ OPTIMAL_Z_TARGET = 29.0) | **~60** |
| GP / день / дерево | **~1,429** |
| Днів до 1 SCC (10,000 GP) | **~7 днів** |

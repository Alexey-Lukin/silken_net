...
- **Стан:** BOM синхронізовано, ціни підтверджено локальними DMLS-виробниками. Шкала готовності тут **незастосовна** — сторінка міряє вартість, а не зрілість; готовність самого заліза живе в [`00_03 §1`](00_03_TRL_Matrix_HIL_and_Beyond) (DOC-T.70 — попередній рядок звітував про залізо числом, вищим за його власний дім)
- **Відкрите:** ціновий моніторинг BOM (DMLS, EBFC) при масштабуванні → [`00_07` — BIZ.17](00_07_Action_Plan_Tracker).
...
| — | **Разом за 1 Queen (Phase 1/2.5):** | **LTE-M / Starlink DTC, 100–300 дерев** | **~$185.00** |

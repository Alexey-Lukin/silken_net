...
Документ — це об'єднаний **Social API Registry**: **Частина A** (нижче §1–§8) — B2G/B2B адміністративно-інфраструктурні стейкхолдери; **Частина B** (§9–§12) — **Культурний шар** (митці, журналісти, диригенти, народні майстри), що транслює сирі D-MRV-цифри у людську емпатію (влито з колишнього 04_07). Жоден запис не блокує production-merge, жоден не в hot-path. Принцип Zero-Trust: матриця інтерфейсів замість художніх есеїв.
...
3. **Lazy activation:** Tier 4 — це майбутні revenue. Активуються

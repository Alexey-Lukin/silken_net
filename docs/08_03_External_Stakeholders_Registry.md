...
- **Інституційний якор:** ЧІПБ ім. Героїв Чорнобиля + ДСНС обласна
  служба. Партнер ідентифікований через 2 окремі особи у
  [`08_02 §3`](08_02_Academic_Institutions_Registry) (Биченко, Ротар).
...
- **Status:** 🔵 Identified. ⚠️ Виправлено 2026-07-17: було «🟢 Engaged (через ЧІПБ)», але [`00_07`](00_07_Action_Plan_Tracker) UNI.12 = **⚪ Не почато**, чекбокс «👤 **cold contact** ректорат» — контакту не було.
...
- **Звання:** Заслужена художниця України; етнодизайн, народна вишивка, орнаментальний патерн («Нарбутівський рушник»). (Народний художник України — її покійний чоловік, скульптор-монументаліст Микола Теліженко, †2024; не плутати.)
...
- **Cross-link:** та сама особа, що «Теліженко О.В.» у [`08_02 §5`](08_02_Academic_Institutions_Registry) — **не два записи**. СЄУ-афіліацію **верифіковано** (web-фах 2026-07-21): доцент каф. дизайну СЄУ, гарант ОП «Дизайн»; резиденція в Сахнівці — паралельна незалежна практика. Запис тут — координація Genesis NFT треку.

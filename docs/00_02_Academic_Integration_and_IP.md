...
| [`01_02` — Ti 6Al 4V Metallurgy and DMLS](01_02_Ti_6Al_4V_Metallurgy_and_DMLS) | Ti-довговічність/Kirkendall — Гусак (коефіцієнт дифузії крізь оксид) + ЧМА токсикологія (Суховий) |
...
- **Авторський колектив не сформований** — партнери ідентифіковані, але жоден не законтрактований co-authorship-MoU (Ярмілко — провідник у ЧНУ, статті за ним не закріплено; UNI.12 = «cold contact» ще не зроблено). Планування виходить з того, що founder пише сам.
...
| **ЧМА** | токсикологія (V/Al · 8-HQ) | персональний контакт |
| **СЄУ** | комерційне/RWA-право, фінансовий облік криптоактивів | персональний контакт |
...
- **B2G land-access (Смілянщина):** канал — **установа**. Ліси колишнього ДП «Смілянське лісове господарство» після реорганізації ДСГП «Ліси України» веде регіональна філія «Центральний лісовий офіс» — та сама установа, що й у B2G land-shield (§1.2), — через Чигиринське надлісництво: так записані ті колишні смілянські лісництва, що є в нашому наборі санітарних рубок 2025–2026 (`tools/ground_truth/cherkasy_sanitary.csv`; desk-звірка 2026-09-26). Предмет: доступ до заказників Смілянщини + еко-аудит; ПЗФ-сумісність координується зі Спрягайлом. ⛔ Юрія Сегеду контактом установи не вписувати: директором філії «Смілянське ЛГ» він був до 30.05.2025 (декларація «перед звільненням»), а за 2025 рік декларує лише мандат депутата Черкаської облради. Дім-стан → [`00_07`](00_07_Action_Plan_Tracker) (STK.2).

### 1.2 ЧДТУ — Черкаський державний технологічний університет

Комплементарний до ЧНУ (3 академ-кафедри): **дані/моделі**, **радіоканал** (натурна верифікація нашого Link Budget; модель Косенюка — опц. друга думка) та **акустичний hardware**. Інституційний якір — перший проректор **Гончаров** (він же RF-верифікація, Ст.23; MoU-підписант).
...
- **Fab-infra (procurement):** механообробка деталей анкера = manufacturing-крок, процес відомий, публікації нема, і окремого CNC-адресата «post-DMLS» у неї немає (⚫ [`00_07`](00_07_Action_Plan_Tracker) UNI.17, 2026-09-26): катодний фланець Zone 3 разом із вушками байонета й PEEK-втулка Zone 2 мають власні листи механообробним цехам, а «різальної геометрії анкера» канон не має. ЧДТУ machine-shop лишається можливим виконавцем тих самих листів; не контактовано.
- **B2G land-shield:** канал — **установа**, філія «Центральний лісовий офіс» ДСГП «Ліси України», що керує держлісами Черкащини вкл. Черкаський бір: легальний доступ до полігону в держлісі (перекласифікація анкера «втручання»→«науково-вимірювальний прилад» + Pilot Site MoU); лісовий квиток на дослідження — від установи-заявника: заявником за делегованим присудом 2026-09-24 обрано кафедру ЧДТУ, її згоди ще немає і запит не надіслано ([`00_07`](00_07_Action_Plan_Tracker) HW.28). Контакт — посада директора філії; імʼя брати з [офіційного графіка прийому ДП](https://e-forest.gov.ua/hrafik-osobystoho-pryjomu/) на дату звернення, а не з цього рядка. ⛔ Олександра Дзюбенка контактом установи не вписувати: директором філії він був з 2022 до березня 2025, коли призначено наступника (desk-звірка 2026-09-26); чи викладає нині в ЧДТУ — не звірено (склад кафедри на її сторінці датовано 2019–2022). Дім-стан → [`00_07`](00_07_Action_Plan_Tracker) (STK.1).
...
Токсикологія Ti (V/Al) і 8-HQ. ЧМА = навчальний коледж (не матеріалознавча лабораторія); інституційний доступ — персонально.
...
| **Глущенко А.В.** (викладач ЧМА) | фармація / фітотерапія | Фітотоксичність 8-HQ self-healing покриття (профіль: рослинні екстракти, хім. аналіз) → [`01_02 §3`](01_02_Ti_6Al_4V_Metallurgy_and_DMLS) — умовно, разом із програмою 8-HQ ([`00_07`](00_07_Action_Plan_Tracker) HW.4) | Ст. 29 |

### 1.5 СЄУ — Східноєвропейський університет

Право й облік (legal wrapper + фінансовий облік криптоактивів).
...
**Ключові результати:** математична модель деградації анкера на 20 років; протокол акселерованого тесту (12 тижнів @ 40°C ≈ 2.2–5.7 польових років при Ea 0.7–1.0 еВ, джерела діапазону немає — ізотерма, [`01_02 §2`](01_02_Ti_6Al_4V_Metallurgy_and_DMLS)); верифікація self-healing покриття на мікрокапсулах з 8-HQ інгібітором. (ICP-MS Ti/Al/V — від coin Stage 2, [`00_07`](00_07_Action_Plan_Tracker) HW.24; Стаття 1 суто обчислювальна.)
...
> ℹ️ Поглинула Статтю 8 (UNI.19): аналітична + експериментальна половини однієї антени зведені, Link Budget більше не стоїть двічі. Reed-Solomon FEC (E.15 — CR 4/5 Hamming уже в кремнії SX126x) і Kalman (E.10 — продукт узяв EMA, FW.21) зняті при злитті.

**Журнали:** IEEE Transactions on Antennas and Propagation (Q1) · IEEE Antennas and Wireless Propagation Letters (Q1) · Sensors (Q1)

| Автор | Внесок |
|-------|--------|
| **Косенюк Г.В.** (ЧНУ ФОТІУС) | FEKO/CST-модель імпедансу, LC-узгодження й 3D-діаграми з Ti-анкером (Zone 1 + Zone 3 фланець) як ground plane — опц., друга думка до виміру |
...
**Тип зв'язку:** Вимір веде ЧДТУ (РТРС, Гончаров): VNA/у лісі → коригування LC → серійна специфікація; модель Косенюка (опц.) — друга думка до виміру. Крипто-навантаження того ж кадру (CCM-MIC ↔ airtime) — наш self-own розрахунок, партнера на ньому немає.
...
**Магістерські/PhD:** Спрягайло (ЧНУ біо — «Динаміка денних/сутіночних піків фауни…») · Базіло/Бондаренко (ЧДТУ ПМКТ бакалавр — «Калібрувальний soundscape-датасет…») · Карапетян (ЧДТУ PhD — «Статистичні методи валідації…»).
...
| **Глущенко А.В.** (ЧМА) | Оцінка фітотоксичності 8-HQ self-healing покриття, альтернативні інгібітори — умовно, з програмою 8-HQ (HW.4) |
...
**Тип зв'язку:** Послідовний — зовнішня лабораторія вимірює концентрації (ICP-MS; у Черкасах приладу немає) → наша модель (script 51) з коефіцієнтом дифузії від школи Гусака екстраполює на 20 років → ЧМА (Суховий) оцінює біологічний вплив + Safety Margin.
...
**Подача ™** — прямий повірений УкрНОІВІ (~5-10k UAH; TISC консультативний, сам не подає); адресатів запиту вартості обрано ⚖️ 2026-09-26 — № 324 ∥ № 219 ([`trademark_brief`](protocols/legal/trademark_brief.md) §7.1), не контактовано.

### 4.2 UA-юр-review → Аблязов + крипто/IP-юрист

**Точковий UA-юр-review:** RWA як `hadron_asset_id` vs Лісовий Кодекс/ПЗФ ([`00_07` BIZ.11](00_07_Action_Plan_Tracker)) · SCC utility-vs-security за ЗУ «Про віртуальні активи» + MiCA ([`05_03`](05_03_Tokenomics_SCC_and_SFC)) · NaaS у Civil Code + `parametric_insurance` ([`00_04`](00_04_Nature_as_a_Service_Contracts)) · AGPL-enforcement + open-license/AF3 ([`00_01 §8`](00_01_Vision_Mission_and_Roadmap)). Виконавець: **Аблязов Д.Е.** (СЄУ, персонально) + профільний крипто/IP-юрист — адресатів запиту вартості обрано ⚖️ 2026-09-26 (CMS ∥ Ellex Valiunas або Sorainen, [`legal_business_outreach`](protocols/outreach/legal_business_outreach.md) §4.1), не контактовано.
...
| 4 | UA-юр-review (Аблязов + крипто/IP-юрист; адресатів обрано 2026-09-26) | 👤 |

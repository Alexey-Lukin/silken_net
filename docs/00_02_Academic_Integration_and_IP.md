...
- **B2G land-shield:** Олександр Дзюбенко (Засл. лісівник України, директор Центрального лісового офісу — ⚠️ нині **ДСГП** «Ліси України», не ДП; ⚠️ **посаду не звірено:** офіційний графік прийому ДП (ред. 2026-08-07) називає директором цієї філії іншу особу — дім розбіжності [`00_07`](00_07_Action_Plan_Tracker) STK.1 — керує держлісами Черкащини вкл. Черкаський бір; + д.е.н., доцент — ⚠️ «проф. каф. лісового господарства ЧДТУ за сумісництвом», що тут стояло, первинкою не підтверджено: сторінка кафедри веде його «зовнішнім сумісником», а список складу кафедри датує це «2019-2022» (звірено 2026-09-25), тож чи звʼязок із кафедрою чинний, не відомо; «Заслужений лісівник України» — 2015, там само) — легальний доступ до полігону в держлісі (перекласифікація анкера «втручання»→«науково-вимірювальний прилад» + Pilot Site MoU) + адмінміст ДП «Ліси України» ↔ ЧДТУ. Дім-стан → [`00_07`](00_07_Action_Plan_Tracker) (STK.1).

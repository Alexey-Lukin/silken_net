...
- [`03_03` — TinyML Acoustic Inference](03_03_TinyML_Acoustic_Inference) (INT8 pure-C forward-pass + CMSIS-DSP log-mel: класифікація пилки · тиші · low-freq water-stress proxy — ⛔ НЕ самої кавітації: її AE = ультразвук 25–150 кГц, поза Nyquist-8 цього тракту)

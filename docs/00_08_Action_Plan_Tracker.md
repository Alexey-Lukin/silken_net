...
- [x] 🤖 **Repo structure:** ✅ Повністю укомплектовано (updated 2026-05-25). L2: `02`-`05` parameterizers + `10` baseline MD + `11` full matrix MD. L3: `20`-`22` DFT + `21b` full bpy. CI: `in_silico_smoke.yml`. Залишається: `cantera_psbma_diffusion.py` (L4).

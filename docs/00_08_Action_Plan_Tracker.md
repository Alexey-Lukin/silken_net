...
| Lorenz константи (Z 2.0/45.0/29.0 · σ10 ρ28 β8÷3 · dt0.01 · 250 iter) | `03_04 §4.1` | 03_01/04_01/04_02/05_01/05_02 (re-stated значення); 08_xx — академ. контекст |
...
- [ ] 🤖 У кожному дублі замінити re-statement значення на 1-рядковий ref на home-док (значення — лише в home).

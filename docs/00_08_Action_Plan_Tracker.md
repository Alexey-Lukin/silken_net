...
- [ ] 🤖 **L3 PCET cascade (script 33):** ⏳ Running (geom-opt FADH• semiquinone, ωB97X). Tests whether proton-coupled oxidation flips cascade downhill. **Preliminary: does NOT flip** (vertical IP wasn't the inflated quantity; ~1 eV gap is PCM differential-solvation limit). Experiment −0.14 eV + B3LYP-corrected −0.07 eV remain authoritative.

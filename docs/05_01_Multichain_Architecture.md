...
5. **Runbook per chain:** для кожної з 11 мереж задокументовано: detection signal, Grafana alert, immediate action (≤15 min), escalation (>1h), recovery procedure. **Ця частина — операційна (адмін)**, не код.

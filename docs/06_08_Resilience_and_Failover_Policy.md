...
>
> ⛔ **Спільна передумова console-рецептів §4.4/§4.6 НЕ доведена:** `kamal app exec … "bin/rails console"` жодного разу не виконувався на живому контейнері (деплою не було) — доки перший запуск не записаний, ці рецепти інертні. Дім передумови — [`06_07 §3`](06_07_CICD_and_Runbook_Index) (шапка Runbook-індексу) + [`00_07`](00_07_Action_Plan_Tracker) `OPS.20`; `coap`-роль для консолі не брати.

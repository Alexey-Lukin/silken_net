...
- **Економія маси:** Пористість 65% (ном., [`01_01 §5.2`](01_01_Coaxial_Gyroid_Topology_and_PEEK)) знижує вагу анкера з 26.5 г до **~9 г** (= §1.2; до 2026-09-10 тут стояло «70% → 8–9 г» — дофризове дзеркало). Вартість металу на виріб — **~$4.00**.

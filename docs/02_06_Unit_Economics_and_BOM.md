...
> 🔴 **Node-total вище є НИЖНЬОЮ МЕЖЕЮ, і рахувати його повним не можна — назви неоцінених елементів стоять поіменно, бо саме цю суму читає зовнішній читач.** Три: **buy-to-fly** DMLS (невикористаний порошок, підпори, вихід рециклінгу — §3 визнає це прямо) · **PEEK-лайнер каналу 0.15 мм** · **механообробка каналу Ø1.3 після друку** (обидва — з lining-присуду 2026-09-10). ⚠️ Це не «діапазон покриє»: діапазон $54.65–$69.65 успадкований від сплав-невизначеності bake-off, а не резерв під неоцінене. Ціни цих трьох приходять із RFQ ([`00_07` BIZ.17](00_07_Action_Plan_Tracker)), і доти будь-яке «повна собівартість вузла» про це число є перебільшенням.

...
> 🔴 **Node-total вище є НИЖНЬОЮ МЕЖЕЮ, і рахувати його повним не можна — назви неоцінених елементів стоять поіменно, бо саме цю суму читає зовнішній читач.** Три: **buy-to-fly** DMLS (невикористаний порошок, підпори, вихід рециклінгу — §3 визнає це прямо) · **PEEK-лайнер каналу** (купована трубка: ID = дріт − 11.41 мкм · OD = ID + 0.30, ⚖️ 2026-09-18, [`01_01 §1.4`](01_01_Coaxial_Gyroid_Topology_and_PEEK)) · **механообробка каналу Ø1.35 після друку** (обидва — з lining-присуду 2026-09-10; номінал відкрито до Ø1.35 присудом про зазор 2026-09-11, [`00_07`](00_07_Action_Plan_Tracker) HW.34 — операція та сама, змінився лише розмір). ⚠️ Це не «діапазон покриє»: діапазон $54.65–$69.65 успадкований від сплав-невизначеності bake-off, а не резерв під неоцінене. Ціни цих трьох приходять із RFQ ([`00_07` BIZ.17](00_07_Action_Plan_Tracker)), і доти будь-яке «повна собівартість вузла» про це число є перебільшенням.

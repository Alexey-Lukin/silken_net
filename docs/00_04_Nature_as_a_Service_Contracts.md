...
| **Денне накопичення** | **Calibration-pending** (`delta_t` recharge-каденція + GP-магнітуда = placeholder, чекають bench-кривої, [E.63](00_07_Action_Plan_Tracker)). Self-consistent realistic (Variant C, `delta_t`≈1.77 год — ⚠️ це грошовий дефолт `scc_rate.rb`, а не чинна енергомодель: з обраним радіо-фронтендом [`02_03 §9.6`](02_03_BQ25570_MPPT_Nano_Power) дає ≈ 1.95 год і ≈ 5.4 SCC/дерево/рік замість ~8, а рух дефолту — відкритий ⚖️ [`00_07`](00_07_Action_Plan_Tracker) ARCH.8; CCM-кадр 30 Б зсуває каденс ще далі, до ≈ 2.22 год): ~13.6 пакети/добу × ~16 stored GP = **~217 growth_points/добу → ~8 SCC/дерево/рік**. Магнітуда = f(EBFC recharge): швидший `delta_t` → вище (фіз. стеля Δt=600s ≈ 326 SCC/рік; 1 TX/год = energy-negative без мітигацій). wire 5–31 × [FW.29] ×2 | [`05_03`](05_03_Tokenomics_SCC_and_SFC), [`02_06 §7.1`](02_06_Unit_Economics_and_BOM), [`02_03 §9`](02_03_BQ25570_MPPT_Nano_Power) |

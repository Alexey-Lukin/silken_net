...
| **Factory Flashing Pipeline** | 🟡 PARTIAL (SEC.3) | ✅ Архітектура (03_06 §1) + HKDF (03_06 §2) + Operations Security threat model + tool implementation + master-key DI (03_06 §5 — `app/services/factory_flashing/*`, `lib/tasks/factory.rake`, RSpec-покрито, dry-run default). Residuals → [`00_07`](00_07_Action_Plan_Tracker) SEC.3 (bench SWD · Bitwarden live · ATCA I²C) |

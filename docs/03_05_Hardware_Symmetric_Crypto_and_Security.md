...
⚠️ **Duty cycle — НЕ єдина регуляторна вісь, і другу цей блок не судить:** чинні загальні умови НКЕК для SRD у 863–870 МГц обмежують ще й **e.i.r.p.**, а +14 дБм із 5-dBi антеною Королеви ([`02_05 §7`](02_05_Queen_Hardware_and_Starlink)) дає ≈19 дБм e.i.r.p. на ЇЇ боці; Солдат має власну бортову SMD-антену ([`02_01 §5`](02_01_Hardware_Architecture_and_BOM)) з іншим — і на нашій малій землі ще не зміряним — підсиленням, тож два боки лінка рахуються ОКРЕМО, і гірший із них вирішує. Звірка з першоджерелом — [`00_07`](00_07_Action_Plan_Tracker) ARCH.24 (👤), і доти «✅» вище стосується рівно duty cycle, нічого більше.

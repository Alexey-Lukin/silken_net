...
- Біти, які ще можна реклемувати без нового байта: `mesh_ctrl.ttl:4` тримає max 15 hop при потребі 0..5 (1 біт вільний), `vpd_index` до HW.32-калібрування = de-facto резервний байт.

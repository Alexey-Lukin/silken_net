...
> ✅ **DR15 resource-conflict — ВИРІШЕНО (2026-05-30):** FW.2 FC **володіє** `RTC_BKP_DR15` (реалізовано — `lora_ccm.h` + `firmware/soldier/main.c`; канонічно у `03_01 §2`). FW.20-S2 anti-storm dedup-bitmap (ARCH.28) переходить на **Flash-KV store** (`03_01 §2.3`), бо всі 20 RTC backup-регістрів (DR0–DR19) зайняті. Стале-формулювання «DR15 наразі резерв» у `00_08`/`03_02` виправлено на цей вердикт.

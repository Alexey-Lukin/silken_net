...
|---------|---------|---------------------|-------------|
| **Парасоль ректорату** | Є.М. Кирилюк (в.о. ректора) | Підпис парасольового MoU ЧНУ↔Silken Net; інституційна координація з ректорами ЧДТУ / ЧІПБ / ЧМА / СЄУ; Triple Helix governance ([`08_07` §1.4](08_07_SEU_Economics_and_Legal_Integration), [`07_03`](07_03_Grant_Applications_Tracker)) | Стаття 34 (Lorenz↔синергетика), Стаття 35 (біоекономіка) |
...
| 4 | Юридичний review RWA-архітектури (Кафедра ІВ) | 👤 Кафедра ІВ + Аблязов Д.Е. (СЄУ) | Меморандум "Юридична допустимість токенізації UA-лісу через ERC-3643" | [`07_01 BLOCKER-6`](07_01_Nature_as_a_Service_Contracts), [`08_07 §1F`](08_07_SEU_Economics_and_Legal_Integration) |

...
Для довідки: 1× LoRa-TX @ +14 dBm ≈ **21.8 мДж** (SF9, [`02_03 §9.6`](02_03_BQ25570_MPPT_Nano_Power); «38/39 мДж» = списаний +22 dBm сценарій; ⚠️ 21.8 — ECB-ерний кадр 16 Б, під CCM 30 Б знаменник росте до ≈29.9 мДж, тобто частки нижче лише ЗМЕНШУЮТЬСЯ — [`00_07`](00_07_Action_Plan_Tracker) ARCH.8); fauna-сесія ≈ **3.6× TX**. Бюджет EDLC 0.47F/5.5V (повний) = 7.1 Дж → fauna-доба = **~2.2 %** буфера. ⚠️ 5.5 В — абсолютний максимум деталі, а не стеля заряду: з ратифікованим `VBAT_OV` 4.822 В ([`02_03 §4`](02_03_BQ25570_MPPT_Nano_Power)) повний буфер ≈ 5.46 Дж, а робоче вікно 3.4 → 4.822 В — 2.75 Дж, тож та сама fauna-доба важить ≈ 2.9 % повного й ≈ 5.7 % робочого вікна (ті самі ≈ 0.16 Дж). Енергетично pivot сумісний з EBFC+EDLC.

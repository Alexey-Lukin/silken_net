...
| Компонент | Модель | ⚠️ Кусає |
|---|---|---|
| 868 антена | **tuned** 5 dBi fiberglass omni — кандидати з паспортом у [`queen_antenna_shortlist`](protocols/hardware/queen_antenna_shortlist.md) §3 (названі тут доти OD8-868 / ALL.4101 первинкою не підтверджені 2026-09-25) | 🔴 НЕ dual-band (VSWR>2.5 @868 → −3-5 дБ); 🔴 антена ПЕРЕД живленням |

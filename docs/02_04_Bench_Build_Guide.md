...
| [`08_02`](08_02_Academic_Institutions_Registry) | Лабораторні протоколи ЧНУ |
...
> node-вартість — [`07_02 §1.2`](07_02_Unit_Economics_and_BOM). Тут — **bench-статус + що кусає**.
...
> ([`08_02`](08_02_Academic_Institutions_Registry)) + розуміння harvester-ланцюга.

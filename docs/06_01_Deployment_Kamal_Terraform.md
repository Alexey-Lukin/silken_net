...
- [x] **SSL/TLS режим `Full (strict)`** — Cloudflare→origin вимагає валідного сертифіката на
      ...
      2026-09-02, next scan Sep 26) — тобто чужий автомат над ратифікованим ⚖️; закріпити
      **Custom → Full (strict)** у SSL/TLS → Configure (👤), інакше присуд тримається дефолтом вендора.

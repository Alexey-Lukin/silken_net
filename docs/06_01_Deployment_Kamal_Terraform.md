...
#    образу/скрипта = in-place + reset; ланцюг нижче лишається рецептом на випадок НАСТУПНОГО replace (напр. machine type):
...
`CANOPY_COAP_HOST`/`PRODUCTION_COAP_HOST` (INF.6) · метрики: пʼять process-таргетів живі (з 09-03),

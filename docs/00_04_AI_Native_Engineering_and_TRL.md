...
4. **Рев'ю (The Architect — *з делегуванням*):** Архітектор перевіряє результат і піднімає рівень TRL. Для нижчих TRL (1-4) рев'ю **делегується** лідам кластерів та CI/CD-perevirkam — Архітектор втручається тільки на TRL Gates (перехід ≥5). Це усуває bottleneck "all-roads-lead-to-Architect" (див. [`00_05 §Async-Review Policy`](00_05_Shape_Up_Operations_and_RnD_Clusters)).
...
- (b) HIL-симуляційними даними з валідною specifikatsiyu контракту з реальним hardware, **АБО**

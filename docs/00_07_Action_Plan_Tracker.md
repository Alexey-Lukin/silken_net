...
- [x] 🤖 **Recompute ТЗ ✅ (1-4 done):** (1) ΔSCF adiabatic dimethyl ✅ (21f/21g) · (2) speciation dimethyl ✅ (34/34b `--dimethyl`, окремі кеші) · (3) gap re-decompose ✅ (substituent +0.146 виділено окремо від bracket) · (4) OCV ✅ (`01_03 §2.1` ~0.50 В, fix «нижча»→«вища»). (5) doc-sweep = drift-audit 2026-06-18 (PIPELINE/08_01 ✅, назва 4,4'-dimethyl ✅; B4/33/fig5-хвіст pending).

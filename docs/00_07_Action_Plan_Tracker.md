...
- **P2** · 🤖 · 🟢 · → `01_02 §6`, `08_02 §1B`
- **Стан:** Машинну половину закрито self-owned (не чекаючи Порубльова/Онищенка, `a5ed3d9`) — двофазний топологічний аудит гіроїда `tools/cad/Connectivity.cs`: SDF-семпл + flood-fill (6-зв'язність, Hoshen-Kopelman) = один обчислювальний прокси **чотирьох** фіз-гейтів — open-pore↔Архімед ([`01_02 §1.2`](01_02_Ti_6Al_4V_Metallurgy_and_DMLS)), pore-percolation↔µCT/EAAE-flow ([`01_02 §1.3`](01_02_Ti_6Al_4V_Metallurgy_and_DMLS), FM-B gas-lock), solid-island↔AM/електро-цілісність аноду ([`01_01 §1`](01_01_Coaxial_Gyroid_Topology_and_PEEK)), closed-pore↔trapped-powder; + adaptive-resolution (solid вимагає крок ≈період/16, інакше тонка стінка фрагментується у фальшиві «острівці»). Pure-managed display-less xUnit-гейт — topology measured, not assumed. Канон [`01_02 §6`](01_02_Ti_6Al_4V_Metallurgy_and_DMLS) + [`08_02 §1B`](08_02_Academic_Institutions_Registry) (Порубльов: партнерська CFD/польова pending); реалізація + робоче вікно `wallParam` — `tools/cad/README` + skill `picogk`.

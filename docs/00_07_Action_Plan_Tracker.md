...
- [x] 🤖 gas-snapshot + coverage-floor CI-гейти **✅** 2026-07-04 (`forge snapshot --check` tolerance 3% vs закомічений baseline + per-file floor ≥90% deployable; обидва gating — [`06_07 §1`](06_07_CICD_and_Runbook_Index))

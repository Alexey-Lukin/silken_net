...
- [x] 🤖 dashboard-gap'и + README-реген + `--dry-run` CI-гейт закрито 2026-07-04 (нові Runtime/Fleet-секції, flapping-rule, money-path панелі; spec-at-source = `deploy/grafana/` IaC + README-шпаргалка; деталь — git)
...
- [x] 🤖 sweeper + спека ✅ 2026-07-04 (`1c9a0ef8` + EVM-scoping `f0263f13` — deep-archival 07-05 канонізував scope у `04_02` і докрив non-EVM regression-спекою)
...
- [x] ✅ upstream-PR подано 2026-07-05: [`Lora-net/LoRaMac-node#1648`](https://github.com/Lora-net/LoRaMac-node/pull/1648) (окремий ST-issue не потрібен — ST синкає Semtech-стек); при прийнятті майбутній реліз зніме потребу форка

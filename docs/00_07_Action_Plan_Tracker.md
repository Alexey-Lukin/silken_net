...
- [ ] 🤖 **[buildable]** Solana RPC-fallback-каскад — `SOLANA_RPC_URL_FALLBACK_*` через наявний `RPC_FALLBACK_ENV_KEYS`-патерн (Celo E.49 вже так; Solana = єдина 1-RPC rail); skip-clean (unset → single-RPC). Дім `06_08 §2.2` крок 7

...
- [ ] 🤖 canary wire-винос: `DR0[10]`-слід → backend (кандидат = event-кадр `0x57` device-event, спека в session-нотатці 2026-07-12 — freeze-contract при потребі, YAGNI до другого споживача)

...
- [ ] 👤 три фліп-гейти рішень ДО/РАЗОМ з фліпом (деталі — flip-checklist [`03_05 §2.1`](03_05_Hardware_Symmetric_Crypto_and_Security)): (а) atomic-cutover кластера · (б) Queen-health blackout до dedicated-каналу (природний дім — ARCH.34) · (в) key-model (спільний ключ до ARCH.43)

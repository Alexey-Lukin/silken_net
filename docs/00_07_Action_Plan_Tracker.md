...
| DOC-T.28 | 🤖 🟡 **code→doc §-ref audit** — `scripts/code_doc_section_refs.rb` (report-only, manual; reuse `Tracker::Dashboard.file_section_dangling_refs` над app/spec/lib; FP-exempt doc-tooling-движок + spec/lib). Закриває guard-сліпий клас, що ховав 00_01-§6.x тижнями (docs-гейти не бачать код-коментарі). ✅ скрипт; 🟡 **backlog 15 stale code-§-рефи**: §14 у 04_02 (×6 insight-воркери) · §5/§7/§2.x у 04_05 (Codex-restructure) · §5.A у 03_06 · §4.4 у 03_02 · §7 у 00_03 — окремий fix-пас | `00_06 §3` |

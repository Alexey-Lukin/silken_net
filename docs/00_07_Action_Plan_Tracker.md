...
- **Стан:** Рандеву-драбина: L1 Queen always-on ✅ · **L2 TDMA-вікна 🟡 host-half (2026-07-02)** · **L3 CAD 🟡 host-half (2026-07-02)** — дім драбини + енерго-політика ролей (full-RX лише Провідник ARCH.27; Солдат = TX-слоти; PANIC = extended-preamble відправника) = [`03_01 §1.9`](03_01_Firmware_Lifecycle_and_DMA); wire-дім розкладки (байти 5..8 маяка, гейти, RAM-only кеш, стеля ±1 с + `ts_frac`-апгрейд) = [`03_02 §5а.2а`](03_02_Queen_Gateway_Firmware); CAD-енерго-double-bind (нюх ≠ EBFC → surplus-Провідник; baseline-пара 3 с ↔ 4 с) = [`02_03 §9.10`](02_03_BQ25570_MPPT_Nano_Power). Точний sync лише з beacon + LSE bench (gossip ±128 с << ±10 мс, FW.49). Розблоковує: FW.27 Design A ([`03_02 §5.1.4`](03_02_Queen_Gateway_Firmware)) · ARCH.43 (рандеву-передумова) · mesh-TTL rev2-рішення ([`03_05 §2.1`](03_05_Hardware_Symmetric_Crypto_and_Security)) · stigmergy-зворотний шлях ([`00_08 §1`](00_08_Beyond_TRL9_Planetary_Roadmap)). Активація post-TRL 6.
...
- [x] ✅ 🤖 L3 host-half (2026-07-02): CAD-нюх за role-прапорцем (`Cad_Sniff_Due`, лише `ROLE_PROVISIONER`) + PANIC extended-preamble «останній зойк» (973 симв @SF9, дворівневий V_cap-гейт fail-closed до FW.50, обов'язковий restore-8) + double-bind енергобюджет у канон — `common/cad_sniff.h` + `test_cad_sniff.c`, глю INERT за `ARCH26_CAD_ENABLED`; див. Стан + [`02_03 §9.10`](02_03_BQ25570_MPPT_Nano_Power)

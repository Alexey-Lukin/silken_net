...
**SilkenNet** — planetary Bio-IoT D-MRV platform for forest monitoring (Ti-6Al-4V gyroid anchor + EBFC → STM32 Soldier → LoRa → Queen gateway → Rails 8.1 / Ruby 4.0.7 / PostgreSQL / Sidekiq → 11-chain Web3 Proof-of-Growth → SCC mint).
